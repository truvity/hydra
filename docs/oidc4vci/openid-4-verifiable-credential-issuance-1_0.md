...
## [**Abstract**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#abstract)

This specification defines an API for the issuance of Verifiable Credentials.

## [**1\.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-1) **[Introduction](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-introduction)**

This specification defines an OAuth-protected API for the issuance of Verifiable Credentials. Credentials can be of any format, including, but not limited to, IETF SD-JWT VC \[[I-D.ietf-oauth-sd-jwt-vc](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#I-D.ietf-oauth-sd-jwt-vc)\], ISO mdoc \[[ISO.18013-5](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#ISO.18013-5)\], and W3C VCDM \[[VC\_DATA](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#VC_DATA)\].
...
### [**1.1.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-1.1) **[Errata revisions](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-errata-revisions)**

The latest revision of this specification, incorporating any errata updates, is published at [openid-4-verifiable-credential-issuance-1\_0](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html). The text of the final specification as approved will always be available at [openid-4-verifiable-credential-issuance-1\_0-final](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0-final.html). When referring to this specification from other documents, it is recommended to reference [openid-4-verifiable-credential-issuance-1\_0](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html).

### [**1.2.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-1.2) **[Requirements Notation and Conventions](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-requirements-notation-and-c)**
...
## [**2\.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-2) **[Terminology](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-terminology)**
...
Credential Format:  
Data Model used to create and represent Credential information. This format defines how various pieces of data within a Verifiable Credential are organized and encoded, ensuring that the Verifiable Credential can be consistently understood, processed, and verified by different systems. The exact parameters required to use a Credential Format in the context of this specification are defined in the Credential Format Profile. Definitions of Credential Formats is out of scope for this specification. Examples for Credential Formats are IETF SD-JWT VC \[[I-D.ietf-oauth-sd-jwt-vc](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#I-D.ietf-oauth-sd-jwt-vc)\], ISO mdoc \[[ISO.18013-5](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#ISO.18013-5)\], and W3C VCDM \[[VC\_DATA](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#VC_DATA)\].  
Credential Format Profile:  
Set of parameters specific to individual Credential Formats. This specification provides Credential Format Profiles for IETF SD-JWT VC \[[I-D.ietf-oauth-sd-jwt-vc](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#I-D.ietf-oauth-sd-jwt-vc)\], ISO mdoc \[[ISO.18013-5](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#ISO.18013-5)\], and W3C VCDM \[[VC\_DATA](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#VC_DATA)\], which can be found in the section [Appendix A](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#format-profiles). Additionally, other specifications or deployments can define their own Credential Format Profiles by utilizing the extension points defined in this specification.  
...
## [**3\.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-3) **[Overview](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-overview)**

### [**3.1.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-3.1) **[Credential Issuer](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-credential-issuer)**
...
### [**3.2.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-3.2) **[OAuth 2.0](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-oauth-20)**
...
### [**3.3.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-3.3) **[Core Concepts](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-core-concepts)**

In the context of this specification, Credential Datasets, Credential Format and Credential Format Profile are defined in [Section 2](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#terminology). While in principle independent of each other, the Credential Dataset and the Credential Format can have a relationship in the sense that an Issuer may only offer certain Credential Formats for certain Credential Datasets.
...
#### [**3.3.1.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-3.3.1) **[Credential Formats and Credential Format Profiles](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-credential-formats-and-cred)**
...
Credential Format Profiles for IETF SD-JWT VC \[[I-D.ietf-oauth-sd-jwt-vc](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#I-D.ietf-oauth-sd-jwt-vc)\], ISO mdoc \[[ISO.18013-5](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#ISO.18013-5)\], and W3C VCDM \[[VC\_DATA](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#VC_DATA)\] are specified in [Appendix A](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#format-profiles). Other specifications or deployments can define their own Credential Format Profiles using the above-mentioned extension points.

#### [**3.3.2.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-3.3.2) **[Batch Credential Issuance](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-batch-credential-issuance)**
...
#### [**3.3.3.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-3.3.3) **[Issuance Flow Variations](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-issuance-flow-variations)**
...
#### [**3.3.4.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-3.3.4) **[Identifying Credentials Being Issued Throughout the Issuance Flow](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-identifying-credentials-bei)**
...
### [**3.4.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-3.4) **[Authorization Code Flow](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-authorization-code-flow)**
...
[*Figure 1*](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#figure-1)*: [Issuance using Authorization Code Flow](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-issuance-using-authorizatio)*  
...
### [**3.5.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-3.5) **[Pre-Authorized Code Flow](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-pre-authorized-code-flow)**
...
[*Figure 2*](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#figure-2)*: [Issuance using Pre-Authorized Code Flow](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-issuance-using-pre-authoriz)*  
...
## [**4\.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-4) **[Credential Offer Endpoint](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-credential-offer-endpoint)**
...
### [**4.1.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-4.1) **[Credential Offer](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-credential-offer)**
...
#### [**4.1.1.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-4.1.1) **[Credential Offer Parameters](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-credential-offer-parameters)**
...
#### [**4.1.2.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-4.1.2) **[Sending Credential Offer by Value Using `credential_offer` Parameter](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-sending-credential-offer-by)**
...
#### [**4.1.3.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-4.1.3) **[Sending Credential Offer by Reference Using `credential_offer_uri` Parameter](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-sending-credential-offer-by-)**
...
### [**4.2.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-4.2) **[Credential Offer Response](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-credential-offer-response)**

The Wallet does not create a response. UX control stays with the Wallet after completion of the process.

## [**5\.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-5) **[Authorization Endpoint](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-authorization-endpoint)**
...
### [**5.1.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-5.1) **[Authorization Request](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-authorization-request)**
...
#### [**5.1.1.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-5.1.1) **[Using Authorization Details Parameter](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-using-authorization-details)**
...
#### [**5.1.2.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-5.1.2) **[Using `scope` Parameter to Request Issuance of a Credential](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-using-scope-parameter-to-re)**
...
Credential Issuers MUST interpret each scope value as a request to access the Credential Endpoint as defined in [Section 8](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#credential-endpoint) for the issuance of a Credential type identified by that scope value. Multiple scope values MAY be present in a single request whereby each occurrence MUST be interpreted individually.
...
#### [**5.1.3.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-5.1.3) **[Additional Request Parameters](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-additional-request-paramete)**
...
Additional Authorization Request parameters MAY be defined and used, as described in \[[RFC6749](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC6749)\]. The Authorization Server MUST ignore any unrecognized parameters.

#### [**5.1.4.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-5.1.4) **[Pushed Authorization Request](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-pushed-authorization-reques)**
...
### [**5.2.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-5.2) **[Successful Authorization Response](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-successful-authorization-re)**
...
### [**5.3.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-5.3) **[Authorization Error Response](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-authorization-error-respons)**
...
## [**6\.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-6) **[Token Endpoint](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-token-endpoint)**
...
### [**6.1.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-6.1) **[Token Request](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-token-request)**
...
Additional Token Request parameters MAY be defined and used, as described in \[[RFC6749](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC6749)\]. The Authorization Server MUST ignore any unrecognized parameters.
...
#### [**6.1.1.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-6.1.1) **[Request Credential Issuance using `authorization_details` Parameter](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-request-credential-issuance)**
...
### [**6.2.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-6.2) **[Successful Token Response](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-successful-token-response)**
...
Additional Token Response parameters MAY be defined and used, as described in \[[RFC6749](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC6749)\]. The Wallet MUST ignore any unrecognized parameters in the Token Response. An included `authorization_details` parameter MAY also have additional data fields defined and used when the `type` value is `openid_credential`. The Wallet MUST ignore any unrecognized data fields in the `authorization_details` present in the Token Response.
...
### [**6.3.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-6.3) **[Token Error Response](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-token-error-response)**
...
## [**7\.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-7) **[Nonce Endpoint](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-nonce-endpoint)**
...
### [**7.1.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-7.1) **[Nonce Request](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-nonce-request)**
...
### [**7.2.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-7.2) **[Nonce Response](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-nonce-response)**
...
## [**8\.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-8) **[Credential Endpoint](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-credential-endpoint)**
...
### [**8.1.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-8.1) **[Binding the Issued Credential to the Identifier of the End-User Possessing that Credential](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-binding-the-issued-credenti)**
...
### [**8.2.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-8.2) **[Credential Request](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-credential-request)**
...
### [**8.3.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-8.3) **[Credential Response](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-credential-response)**
...
#### [**8.3.1.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-8.3.1) **[Credential Error Response](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-credential-error-response)**
...
##### [**8.3.1.1.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-8.3.1.1) **[Authorization Errors](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-authorization-errors)**
...
##### [**8.3.1.2.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-8.3.1.2) **[Credential Request Errors](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-credential-request-errors)**
...
## [**9\.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-9) **[Deferred Credential Endpoint](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-deferred-credential-endpoin)**
...
### [**9.1.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-9.1) **[Deferred Credential Request](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-deferred-credential-request)**
...
### [**9.2.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-9.2) **[Deferred Credential Response](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-deferred-credential-respons)**
...
### [**9.3.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-9.3) **[Deferred Credential Error Response](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-deferred-credential-error-r)**
...
## [**10\.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-10) **[Encrypted Credential Requests and Responses](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-encrypted-credential-reques)**
...
## [**11\.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-11) **[Notification Endpoint](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-notification-endpoint)**
...
### [**11.1.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-11.1) **[Notification Request](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-notification-request)**
...
### [**11.2.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-11.2) **[Successful Notification Response](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-successful-notification-res)**
...
### [**11.3.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-11.3) **[Notification Error Response](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-notification-error-response)**
...
## [**12\.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-12) **[Metadata](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-metadata)**

### [**12.1.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-12.1) **[Client Metadata](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-client-metadata)**

This specification defines the following new Client Metadata parameter in addition to those defined by \[[RFC7591](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC7591)\] for Wallets acting as OAuth 2.0 Client:

* `credential_offer_endpoint`: OPTIONAL. Credential Offer Endpoint of a Wallet.

Additional Client metadata parameters MAY be defined and used, as described in \[[RFC7591](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC7591)\]. The Wallet MUST ignore any unrecognized parameters.

#### [**12.1.1.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-12.1.1) **[Client Metadata Retrieval](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-client-metadata-retrieval)**
...
### [**12.2.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-12.2) **[Credential Issuer Metadata](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-credential-issuer-metadata)**
...
#### [**12.2.1.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-12.2.1) **[Credential Issuer Identifier](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-credential-issuer-identifie)**
...
#### [**12.2.2.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-12.2.2) **[Credential Issuer Metadata Retrieval](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-credential-issuer-metadata-)**
...
The Credential Issuer MUST respond with HTTP Status Code 200 and return the Credential Issuer Metadata containing the parameters defined in [Section 12.2.4](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#credential-issuer-parameters) as either
...
The language(s) in HTTP `Accept-Language` and `Content-Language` Headers MUST use the values defined in \[[RFC3066](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC3066)\].
...
#### [**12.2.3.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-12.2.3) **[Signed Metadata](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-signed-metadata)**

The signed metadata MUST be secured using a JSON Web Signature (JWS) \[[RFC7515](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC7515)\] and contain the following elements:

* in the JOSE header,  
  * `alg`: REQUIRED. A digital signature algorithm identifier such as per IANA "JSON Web Signature and Encryption Algorithms" registry \[[IANA.JOSE](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#IANA.JOSE)\]. It MUST NOT be `none` or an identifier for a symmetric algorithm (MAC).  
  * `typ`: REQUIRED. MUST be `openidvci-issuer-metadata+jwt`, which explicitly types the key proof JWT as recommended in Section 3.11 of \[[RFC8725](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC8725)\].  
* in the JWS payload,  
  ...
  * `iat`: REQUIRED. Integer for the time at which the Credential Issuer Metadata was issued using the syntax defined in \[[RFC7519](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC7519)\].  
  * `exp`: OPTIONAL. Integer for the time at which the Credential Issuer Metadata is expiring, using the syntax defined in \[[RFC7519](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC7519)\].

All [metadata parameters](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#credential-issuer-parameters) used by the Credential Issuer MUST be added as top-level claims in the JWS payload.
...
See [Appendix I.1](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#additional-issuer-metadata-examples) for a non-normative example of signed Credential Issuer Metadata.

#### [**12.2.4.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-12.2.4) **[Credential Issuer Metadata Parameters](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-credential-issuer-metadata-p)**

This specification defines the following Credential Issuer Metadata parameters:

* `credential_issuer`: REQUIRED. The Credential Issuer's identifier, as defined in [Section 12.2.1](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#credential-issuer-identifier). The value MUST be identical to the Credential Issuer's identifier value into which the well-known URI string was inserted to create the URL used to retrieve the metadata. If these values are not identical (when compared using a simple string comparison with no normalization), the data contained in the response MUST NOT be used.  
...
* `credential_endpoint`: REQUIRED. URL of the Credential Issuer's Credential Endpoint, as defined in [Section 8.2](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#credential-request). This URL MUST use the `https` scheme and MAY contain port, path, and query parameter components.  
* `nonce_endpoint`: OPTIONAL. URL of the Credential Issuer's Nonce Endpoint, as defined in [Section 7](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#nonce-endpoint). This URL MUST use the `https` scheme and MAY contain port, path, and query parameter components. If omitted, the Credential Issuer does not require the use of `c_nonce`.  
* `deferred_credential_endpoint`: OPTIONAL. URL of the Credential Issuer's Deferred Credential Endpoint, as defined in [Section 9](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#deferred-credential-issuance). This URL MUST use the `https` scheme and MAY contain port, path, and query parameter components. If omitted, the Credential Issuer does not support the Deferred Credential Endpoint.  
* `notification_endpoint`: OPTIONAL. URL of the Credential Issuer's Notification Endpoint, as defined in [Section 11](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#notification-endpoint). This URL MUST use the `https` scheme and MAY contain port, path, and query parameter components. If omitted, the Credential Issuer does not support the Notification Endpoint.  
* `credential_request_encryption`: OPTIONAL. Object containing information about whether the Credential Issuer supports encryption of the Credential Request on top of TLS.  
  * `jwks`: REQUIRED. A JSON Web Key Set, as defined in \[[RFC7591](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC7591)\], that contains one or more public keys, to be used by the Wallet as an input to a key agreement for encryption of the Credential Request. Each JWK in the set MUST have a kid (Key ID) parameter that uniquely identifies the key.  
  * `enc_values_supported`: REQUIRED. A non-empty array containing a list of the JWE \[[RFC7516](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC7516)\] encryption algorithms (`enc` values) \[[RFC7518](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC7518)\] supported by the Credential Endpoint to decode the Credential Request from a JWT \[[RFC7519](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC7519)\].  
  * `zip_values_supported`: OPTIONAL. A non-empty array containing a list of the JWE \[[RFC7516](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC7516)\] compression algorithms (`zip` values) \[[RFC7518](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC7518)\] supported by the Credential Endpoint to uncompress the Credential Request after decryption. If absent then no compression algorithms are supported. The Wallet may use any of the supported compression algorithm to compress the Credential Request prior to encryption.  
...
* `credential_response_encryption`: OPTIONAL. Object containing information about whether the Credential Issuer supports encryption of the Credential Response on top of TLS.  
  * `alg_values_supported`: REQUIRED. A non-empty array containing a list of the JWE \[[RFC7516](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC7516)\] encryption algorithms (`alg` values) \[[RFC7518](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC7518)\] supported by the Credential Endpoint to encode the Credential Response in a JWT \[[RFC7519](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC7519)\].  
  * `enc_values_supported`: REQUIRED. A non-empty array containing a list of the JWE \[[RFC7516](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC7516)\] encryption algorithms (`enc` values) \[[RFC7518](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC7518)\] supported by the Credential Endpoint to encode the Credential Response in a JWT \[[RFC7519](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC7519)\].  
  * `zip_values_supported`: OPTIONAL. A non-empty array containing a list of the JWE \[[RFC7516](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC7516)\] compression algorithms (`zip` values) \[[RFC7518](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC7518)\] supported by the Credential Endpoint to compress the Credential Response prior to encryption. If absent then compression is not supported.  
...
* `display`: OPTIONAL. A non-empty array of objects, where each object contains display properties of a Credential Issuer for a certain language. Below is a non-exhaustive list of valid parameters that MAY be included:  
  ...
  * `locale`: OPTIONAL. String value that identifies the language of this object represented as a language tag taken from values defined in BCP47 \[[RFC5646](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC5646)\]. There MUST be only one object for each language identifier.  
...
* `credential_configurations_supported`: REQUIRED. Object that describes specifics of the Credential that the Credential Issuer supports issuance of. This object contains a list of name/value pairs, where each name is a unique identifier of the supported Credential being described. This identifier is used in the Credential Offer as defined in [Section 4.1.1](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#credential-offer-parameters) to communicate to the Wallet which Credential is being offered. The value is an object that contains metadata about a specific Credential and contains the following parameters defined by this specification:  
  * `format`: REQUIRED. A JSON string identifying the format of this Credential, i.e., `jwt_vc_json` or `ldp_vc`. Depending on the format value, the object contains further elements defining the type and (optionally) particular claims the Credential MAY contain and information about how to display the Credential. [Appendix A](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#format-profiles) contains Credential Format Profiles introduced by this specification.  
  * `scope`: OPTIONAL. A JSON string identifying the scope value that this Credential Issuer supports for this particular Credential. The value can be the same across multiple `credential_configurations_supported` objects. The Authorization Server MUST be able to uniquely identify the Credential Issuer based on the scope value. The Wallet can use this value in the Authorization Request as defined in [Section 5.1.2](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#credential-request-using-type-specific-scope). Scope values in this Credential Issuer metadata MAY duplicate those in the `scopes_supported` parameter of the Authorization Server. If `scope` is absent, the only way to request the Credential is using `authorization_details` \[[RFC9396](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC9396)\] \- in this case, the OAuth Authorization Server metadata for one of the Authorization Servers found from the Credential Issuer's Metadata must contain an `authorization_details_types_supported` that contains `openid_credential`.  
  * `credential_signing_alg_values_supported`: OPTIONAL. A non-empty array of algorithm identifiers that identify the algorithms that the Issuer uses to sign the issued Credential. Algorithm identifier types and values used are determined by the Credential Format and are defined in [Appendix A](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#format-profiles).  
  * `cryptographic_binding_methods_supported`: OPTIONAL. A non-empty array of case sensitive strings that identify the representation of the cryptographic key material that the issued Credential is bound to, as defined in [Section 8.1](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#credential-binding). It MUST be present when Cryptographic Key Binding is required for a Credential, and omitted otherwise. If absent, Cryptographic Key Binding is not required for this credential. Support for keys in JWK format \[[RFC7517](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC7517)\] is indicated by the value `jwk`. Support for keys expressed as a COSE Key object \[[RFC8152](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC8152)\] (for example, used in \[[ISO.18013-5](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#ISO.18013-5)\]) is indicated by the value `cose_key`. When the Cryptographic Key Binding method is a DID, valid values are a `did:` prefix followed by a method-name using a syntax as defined in Section 3.1 of \[[DID-Core](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#DID-Core)\], but without a `:` and method-specific-id. For example, support for the DID method with a method-name "example" would be represented by `did:example`.  
  * `proof_types_supported`: OPTIONAL. Object that describes specifics of the key proof(s) that the Credential Issuer supports. It MUST be present if `cryptographic_binding_methods_supported` is present, and omitted otherwise. If absent, the Wallet is not required to supply proofs when requesting this credential. This object contains a list of name/value pairs, where each name is a unique identifier of the supported proof type(s). Valid values are defined in [Appendix F](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#proof-types), other values MAY be used. The Wallet also uses this identifier in the Credential Request as defined in [Section 8.2](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#credential-request). The value in the name/value pair is an object that contains metadata about the key proof and contains the following parameters defined by this specification:  
    * `proof_signing_alg_values_supported`: REQUIRED. A non-empty array of algorithm identifiers that the Issuer supports for this proof type. The Wallet uses one of them to sign the proof. Algorithm identifier types and values used are determined by the proof type and are defined in [Appendix F](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#proof-types).  
    * `key_attestations_required`: OPTIONAL. Object that describes the requirement for key attestations as described in [Appendix D](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#keyattestation), which the Credential Issuer expects the Wallet to send within the proof(s) of the Credential Request. If the Credential Issuer does not require a key attestation, this parameter MUST NOT be present in the metadata. If both `key_storage` and `user_authentication` parameters are absent, the `key_attestations_required` parameter may be empty, indicating a key attestation is needed without additional constraints.  
      * `key_storage`: OPTIONAL. A non-empty array defining values specified in [Appendix D.2](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#keyattestation-apr) accepted by the Credential Issuer.  
      * `user_authentication`: OPTIONAL. A non-empty array defining values specified in [Appendix D.2](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#keyattestation-apr) accepted by the Credential Issuer.  
  * `credential_metadata`: OPTIONAL. Object containing information relevant to the usage and display of issued Credentials. Credential Format-specific mechanisms can overwrite the information in this object to convey Credential metadata. Format-specific mechanisms, such as SD-JWT VC display metadata are always preferred by the Wallet over the information in this object, which serves as the default fallback. Below is a non-exhaustive list of parameters that MAY be included:  
    * `display`: OPTIONAL. A non-empty array of objects, where each object contains the display properties of the supported Credential for a certain language. Below is a non-exhaustive list of parameters that MAY be included.  
      ...
      * `locale`: OPTIONAL. String value that identifies the language of this object represented as a language tag taken from values defined in BCP47 \[[RFC5646](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC5646)\]. Multiple `display` objects MAY be included for separate languages. There MUST be only one object for each language identifier.  
      ...
      * `background_color`: OPTIONAL. String value of a background color of the Credential represented as numerical color values defined in CSS Color Module Level 3 \[[CSS-Color](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#CSS-Color)\].  
      ...
      * `text_color`: OPTIONAL. String value of a text color of the Credential represented as numerical color values defined in CSS Color Module Level 3 \[[CSS-Color](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#CSS-Color)\].  
    * `claims`: OPTIONAL. A non-empty array of claims description objects as defined in [Appendix B.2](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#claims-description-issuer-metadata).

An Authorization Server that only supports the Pre-Authorized Code grant type MAY omit the `response_types_supported` parameter in its metadata despite \[[RFC8414](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC8414)\] mandating it.

Note: It can be challenging for a Credential Issuer that accepts tokens from multiple Authorization Servers to introspect an Access Token to check the validity and determine the permissions granted. Some ways to achieve this are relying on Authorization Servers that use \[[RFC9068](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC9068)\] or by the Credential Issuer understanding the proprietary Access Token structures of the Authorization Servers.

Depending on the Credential Format, additional parameters might be present in the `credential_configurations_supported` object values, such as information about claims in the Credential. For Credential Format-specific claims, see the "Credential Issuer Metadata" subsections in [Appendix A](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#format-profiles).
...
The following is a non-normative example of Credential Issuer metadata of a Credential in the IETF SD-JWT VC \[[I-D.ietf-oauth-sd-jwt-vc](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#I-D.ietf-oauth-sd-jwt-vc)\] format:
...
See [Appendix I.1](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#additional-issuer-metadata-examples) for additional examples of Credential Issuer Metadata.

### [**12.3.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-12.3) **[OAuth 2.0 Authorization Server Metadata](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-oauth-20-authorization-serv)**

This specification also defines a new OAuth 2.0 Authorization Server metadata \[[RFC8414](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC8414)\] parameter to publish whether the Authorization Server that the Credential Issuer relies on for authorization supports anonymous Token Requests with the Pre-Authorized Grant Type. It is defined as follows:
...
Additional Authorization Server metadata parameters MAY be defined and used, as described in \[[RFC8414](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC8414)\]. The Wallet MUST ignore any unrecognized parameters.

## [**13\.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-13) **[Security Considerations](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-security-considerations)**

### [**13.1.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-13.1) **[Formal Security Analysis](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-formal-security-analysis)**

The security properties of some features in a previous revision of this specification have been formally analyzed, see \[[secanalysis](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#secanalysis)\].

### [**13.2.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-13.2) **[Best Current Practice for OAuth 2.0 Security](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-best-current-practice-for-o)**

Implementers of this specification SHOULD follow the Best Current Practice for OAuth 2.0 Security given in \[[BCP240](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#BCP240)\]. It is RECOMMENDED that implementers do this by following the \[[FAPI2\_Security\_Profile](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#FAPI2_Security_Profile)\] where it is applicable.

The parts of \[[FAPI2\_Security\_Profile](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#FAPI2_Security_Profile)\] that may not be applicable when using this specification are:

1. Client authentication: The private\_key\_jwt and MTLS client authentication methods may not be practical to implement in a secure way for native app Wallets. The use of Wallet Attestations as defined in [Appendix E](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#walletattestation) is RECOMMENDED instead.  
2. Sender-constrained access tokens: MTLS sender constrained access token may not be practical to implement in a secure way for native app Wallets. The use of DPoP \[[RFC9449](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC9449)\] is RECOMMENDED.

### [**13.3.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-13.3) **[Trust between Wallet and Issuer](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-trust-between-wallet-and-is)**
...
**Wallet Attestation** is a signed proof provided by the Wallet Provider, verifying the client's authenticity and genuineness. This process uses the mechanisms outlined in Attestation-Based Client Authentication, described in the Section [Wallet Attestation](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#walletattestation). Once obtained, the Wallet Attestation can be used as a client authentication for the Wallet.

### [**13.4.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-13.4) **[Split-Architecture Wallets](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-split-architecture-wallets)**
...
### [**13.5.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-13.5) **[Credential Offer](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-credential-offer-2)**
...
### [**13.6.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-13.6) **[Pre-Authorized Code Flow](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-pre-authorized-code-flow-2)**

#### [**13.6.1.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-13.6.1) **[Replay Prevention](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-replay-prevention)**
...
#### [**13.6.2.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-13.6.2) **[Transaction Code Phishing](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-transaction-code-phishing)**
...
### [**13.7.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-13.7) **[Credential Lifecycle Management](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-credential-lifecycle-manage)**
...
### [**13.8.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-13.8) **[Proof replay](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-proof-replay)**

If an adversary obtains a key proof (as outlined in [Appendix F](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#proof-types)), they could potentially replay that proof to a Credential Issuer to obtain a duplicate Credential or multiple duplicates issued to the same key. The `c_nonce` parameter serves as the main defense against this, by providing Credential Issuers with a mechanism to determine freshness of a generated proof and thus reject a proof when required. It is RECOMMENDED that Credential Issuers utilize the Nonce Endpoint as specified in [Section 7](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#nonce-endpoint) to protect against this. A Wallet can continue using a given nonce until it is rejected by the Credential Issuer. The Credential Issuer determines for how long a particular nonce can be used.

Note: For the attacker to be able to present a Credential bound to a replayed key proof to the Verifier, the attacker also needs to obtain the victim's private key. To limit this, Credential Issuers are RECOMMENDED to check how the Wallet protects the private keys, using mechanisms defined in [Appendix D](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#keyattestation).
...
### [**13.9.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-13.9) **[TLS Requirements](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-tls-requirements)**

Implementations MUST follow \[[BCP195](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#BCP195)\]. Whenever TLS is used, a TLS server certificate check MUST be performed, per \[[RFC6125](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC6125)\].

### [**13.10.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-13.10) **[Protecting the Access Token](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-protecting-the-access-token)**
...
To sender-constrain Access Tokens, see the recommendations in [Section 13.2](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#securitybcp). If Bearer Access Tokens are stored by the Wallet, they MUST be stored in a secure manner, for example, encrypted using a key stored in a protected key store.

### [**13.11.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-13.11) **[Application-Layer Encryption](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-application-layer-encryptio)**
...
## [**14\.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-14) **[Implementation Considerations](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-implementation-consideratio)**

### [**14.1.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-14.1) **[Claims-based Holder Binding of the Credential to the End-User possessing the Credential](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-claims-based-holder-binding)**
...
### [**14.2.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-14.2) **[Binding of the Credential without Cryptographic Key Binding or Claims-based Holder Binding](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-binding-of-the-credential-w)**
...
### [**14.3.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-14.3) **[Multiple Accesses to the Credential Endpoint](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-multiple-accesses-to-the-cr)**
...
1. Use the \[[DIF.Well-Known\_DID](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#DIF.Well-Known_DID)\] Specification to provide binding between a DID and a certain domain.  
2. If the Issuer Identifier in the issued Credential is an object, add to the object a `credential_issuer` claim, as defined in [Section 12.2.1](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#credential-issuer-identifier).
...
### [**14.5.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-14.5) **[Refreshing Issued Credentials](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-refreshing-issued-credentia)**
...
### [**14.6.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-14.6) **[Batch Issuing Credentials](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-batch-issuing-credentials)**
...
### [**14.7.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-14.7) **[Pre-Final Specifications](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-pre-final-specifications)**
...
## [**15\.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-15) **[Privacy Considerations](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-privacy-considerations)**
...
### [**15.1.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-15.1) **[User Consent](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-user-consent)**
...
### [**15.2.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-15.2) **[Minimum Disclosure](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-minimum-disclosure)**
...
### [**15.3.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-15.3) **[Storage of the Credentials](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-storage-of-the-credentials)**
...
### [**15.4.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-15.4) **[Correlation](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-correlation)**

#### [**15.4.1.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-15.4.1) **[Unique Values Encoded in the Credential](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-unique-values-encoded-in-th)**
...
#### [**15.4.2.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-15.4.2) **[Credential Offer](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-credential-offer-3)**

The Privacy Considerations in Section 11.2 of \[[RFC9101](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC9101)\] apply to the `credential_offer` and `credential_offer_uri` parameters defined in [Section 4.1](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#credential-offer).

#### [**15.4.3.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-15.4.3) **[Authorization Request](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-authorization-request-2)**
...
#### [**15.4.4.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-15.4.4) **[Wallet Attestation Subject](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-wallet-attestation-subject)**

The Wallet Attestation as defined in [Appendix E](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#walletattestation) SHOULD NOT introduce a unique identifier specific to a single client. The subject claim for the Wallet Attestation SHOULD be a value that is shared by all Wallet instances using this type of wallet implementation. The value should be understood as an identifier of the Wallet type, rather than the specific Wallet instance itself.

### [**15.5.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-15.5) **[Identifying the Credential Issuer](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-identifying-the-credential-)**
...
### [**15.6.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-15.6) **[Identifying the Wallet](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-identifying-the-wallet)**
...
### [**15.7.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-15.7) **[Untrusted Wallets](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-untrusted-wallets)**

The Wallet transmits and stores sensitive information about the End-User. To ensure that the Wallet can handle those appropriately (i.e., according to a certain trust framework or a regulation), the Credential Issuer should properly authenticate the Wallet and ensure it is a trusted entity. For more details, see [Section 13.3](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#trust-between-wallet-and-issuer).

## [**16\.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-16) **[Normative References](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-normative-references)**

**\[BCP195\]**  
IETF, "BCP195", November 2022, \<[https://www.rfc-editor.org/info/bcp195](https://www.rfc-editor.org/info/bcp195)\>.

**\[CSS-Color\]**  
Çelik, T., Lilley, C., and D. Baron, "CSS Color Module Level 3", 18 January 2022, \<[https://www.w3.org/TR/2022/REC-css-color-3-20220118/](https://www.w3.org/TR/2022/REC-css-color-3-20220118/)\>.

**\[DID-Core\]**  
Sporny, M., Guy, A., Sabadello, M., and D. Reed, "Decentralized Identifiers (DIDs) v1.0", 19 July 2022, \<[https://www.w3.org/TR/2022/REC-did-core-20220719/](https://www.w3.org/TR/2022/REC-did-core-20220719/)\>.
...
Terbu, O., Fett, D., and B. Campbell, "SD-JWT-based Verifiable Credentials (SD-JWT VC)", Work in Progress, Internet-Draft, draft-ietf-oauth-sd-jwt-vc-11, 15 September 2025, \<[https://datatracker.ietf.org/doc/html/draft-ietf-oauth-sd-jwt-vc-11](https://datatracker.ietf.org/doc/html/draft-ietf-oauth-sd-jwt-vc-11)\>.
...
## [**17\.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#section-17) **[Informative References](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-informative-references)**

**\[BCP240\]**  
IETF, "BCP240", January 2025, \<[https://www.rfc-editor.org/info/bcp240](https://www.rfc-editor.org/info/bcp240)\>.
...
**\[JSON-LD\]**  
Kellogg, G., Sporny, M., Longley, D., Lanthaler, M., Champin, P., and N. Lindström, "JSON-LD 1.1: A JSON-based Serialization for Linked Data.", 16 July 2020, \<[https://www.w3.org/TR/2020/REC-json-ld11-20200716/](https://www.w3.org/TR/2020/REC-json-ld11-20200716/)\>.
...
**\[VC\_DATA\_2.0\]**  
Sporny, M., Jr, T. T., Herman, I., and G. Cohen, "Verifiable Credentials Data Model 2.0", 15 May 2025, \<[https://www.w3.org/TR/2025/REC-vc-data-model-2.0-20250515/](https://www.w3.org/TR/2025/REC-vc-data-model-2.0-20250515/)\>.

**\[VC\_Data\_Integrity\]**  
Sporny, M., Jr, T. T., Herman, I., Longley, D., and G. Bernstein, "Verifiable Credential Data Integrity 1.0", 15 May 2025, \<[https://www.w3.org/TR/2025/REC-vc-data-integrity-20250515/](https://www.w3.org/TR/2025/REC-vc-data-integrity-20250515/)\>.

**\[secanalysis\]**  
Hauck, F., "OpenID for Verifiable Credentials: Formal Security Analysis using the Web Infrastructure Model", 2 October 2023, \<[https://elib.uni-stuttgart.de/items/07055a8e-a85e-42b9-98b5-11f046d5fb91](https://elib.uni-stuttgart.de/items/07055a8e-a85e-42b9-98b5-11f046d5fb91)\>.

## [**Appendix A.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-A) **[Credential Format Profiles](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-credential-format-profiles)**
...
### [**A.1.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-A.1) **[W3C Verifiable Credentials](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-w3c-verifiable-credentials)**

Sections 6.1 and 6.2 of \[[VC\_DATA](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#VC_DATA)\] define how Verifiable Credentials MAY or MAY NOT use JSON-LD \[[JSON-LD](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#JSON-LD)\]. As acknowledged in Section 4.1 of \[[VC\_DATA](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#VC_DATA)\], implementations can behave differently regarding processing of the `@context` property whether JSON-LD is used or not.
...
#### [**A.1.1.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-A.1.1) **[VC Signed as a JWT, Not Using JSON-LD](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-vc-signed-as-a-jwt-not-usin)**

##### [**A.1.1.1.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-A.1.1.1) **[Format Identifier](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-format-identifier)**
...
##### [**A.1.1.2.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-A.1.1.2) **[Credential Issuer Metadata](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-credential-issuer-metadata-2)**

Cryptographic algorithm identifiers used in the `credential_signing_alg_values_supported` parameter are case sensitive strings and SHOULD be one of those JWS Algorithm Names defined in \[[IANA.JOSE](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#IANA.JOSE)\].

The following additional Credential Issuer metadata parameters are defined for this Credential Format for use in the `credential_configurations_supported` parameter, in addition to those defined in [Section 12.2.4](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#credential-issuer-parameters).
...
* `credential_definition`: REQUIRED. Object containing the detailed description of the Credential type. It consists of the following parameter:  
  * `type`: REQUIRED. Array designating the types a certain Credential type supports, according to \[[VC\_DATA](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#VC_DATA)\], Section 4.3.
...
##### [**A.1.1.3.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-A.1.1.3) **[Authorization Details](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-authorization-details)**
...
##### [**A.1.1.4.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-A.1.1.4) **[Credential Response](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-credential-response-2)**
...
#### [**A.1.2.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-A.1.2) **[VC Secured using Data Integrity, using JSON-LD, with a Proof Suite Requiring Linked Data Canonicalization](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-vc-secured-using-data-integ)**

##### [**A.1.2.1.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-A.1.2.1) **[Format Identifier](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-format-identifier-2)**
...
##### [**A.1.2.2.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-A.1.2.2) **[Credential Issuer Metadata](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-credential-issuer-metadata-3)**

Cryptographic algorithm identifiers used in the `credential_signing_alg_values_supported` parameter are case sensitive strings and SHOULD be one of those signature suite identifiers defined in \[[LD\_Suite\_Registry](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#LD_Suite_Registry)\].
...
* `credential_definition`: REQUIRED. Object containing the detailed description of the Credential type. It consists of the following parameters:  
  * `@context`: REQUIRED. Array as defined in \[[VC\_DATA](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#VC_DATA)\], Section 4.1.  
  * `type`: REQUIRED. Array designating the types a certain credential type supports, according to \[[VC\_DATA](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#VC_DATA)\], Section 4.3.
...
##### [**A.1.2.3.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-A.1.2.3) **[Authorization Details](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-authorization-details-2)**
...
##### [**A.1.2.4.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-A.1.2.4) **[Credential Response](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-credential-response-3)**
...
#### [**A.1.3.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-A.1.3) **[VC signed as a JWT, Using JSON-LD](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-vc-signed-as-a-jwt-using-js)**

##### [**A.1.3.1.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-A.1.3.1) **[Format Identifier](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-format-identifier-3)**
...
##### [**A.1.3.2.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-A.1.3.2) **[Credential Issuer Metadata](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-credential-issuer-metadata-4)**

The definitions in [Appendix A.1.2.2](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#server-metadata-ldp-vc) apply for metadata of Credentials of this type as well.

##### [**A.1.3.3.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-A.1.3.3) **[Authorization Details](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-authorization-details-3)**

The definitions in [Appendix A.1.2.3](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#authorization-ldp-vc) apply for Credentials of this type as well.

##### [**A.1.3.4.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-A.1.3.4) **[Credential Response](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-credential-response-4)**

The definitions in [Appendix A.1.1.4](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#credential-response-jwt-vc-json) apply for Credentials of this type as well.

### [**A.2.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-A.2) **[Mobile Documents or mdocs (ISO/IEC 18013\)](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-mobile-documents-or-mdocs-i)**

This section defines a Credential Format Profile for credentials that conform to the mobile document (mdoc) format specified in ISO/IEC 18013-5 \[[ISO.18013-5](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#ISO.18013-5)\].

ISO/IEC 18013-5:2021 \[[ISO.18013-5](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#ISO.18013-5)\] defines the mdoc format in the context of mobile driving licences (mDLs). While the specification is focused on mDLs, the mdoc format itself is general-purpose and can be used for other types of Credentials.

#### [**A.2.1.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-A.2.1) **[Format Identifier](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-format-identifier-4)**
...
#### [**A.2.2.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-A.2.2) **[Credential Issuer Metadata](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-credential-issuer-metadata-5)**

Cryptographic algorithm identifiers used in the `credential_signing_alg_values_supported` parameter correspond to the numeric COSE algorithm identifiers used to secure the `IssuerAuth` COSE structure, as defined in \[[ISO.18013-5](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#ISO.18013-5)\]. The values SHOULD be chosen from the following:

* The value exactly matches the `alg` value in the `IssuerAuth` COSE header;  
* Or, the value is a fully specified algorithm, as defined in \[[I-D.ietf-jose-fully-specified-algorithms](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#I-D.ietf-jose-fully-specified-algorithms)\], and the combination of the `alg` value and the signing key's curve in the `IssuerAuth` COSE structure matches the combination specified by the fully specified algorithm.
...
Example: If the `IssuerAuth` structure contains an `alg` header value of `-7` (ECDSA with SHA-256, per \[[IANA.COSE](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#IANA.COSE)\]) and is signed using a P-256 key, it matches both `-7` and `-9` in `credential_signing_alg_values_supported`. The latter (`-9`) corresponds to ECDSA with P-256 and SHA-256, as defined in \[[I-D.ietf-jose-fully-specified-algorithms](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#I-D.ietf-jose-fully-specified-algorithms)\].

The following additional Credential Issuer metadata parameters are defined for this Credential Format for use in the `credential_configurations_supported` parameter, in addition to those defined in [Section 12.2.4](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#credential-issuer-parameters).

* `doctype`: REQUIRED. String identifying the Credential type, as defined in \[[ISO.18013-5](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#ISO.18013-5)\].
...
#### [**A.2.3.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-A.2.3) **[Authorization Details](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-authorization-details-4)**
...
#### [**A.2.4.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-A.2.4) **[Credential Response](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-credential-response-5)**

The value of the `credential` claim in the Credential Response MUST be a string that is the base64url-encoded representation of the CBOR-encoded `IssuerSigned` structure, as defined in \[[ISO.18013-5](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#ISO.18013-5)\].
...
### [**A.3.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-A.3) **[IETF SD-JWT VC](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-ietf-sd-jwt-vc)**

This section defines a Credential Format Profile for Credentials complying with \[[I-D.ietf-oauth-sd-jwt-vc](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#I-D.ietf-oauth-sd-jwt-vc)\].

#### [**A.3.1.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-A.3.1) **[Format Identifier](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-format-identifier-5)**

The Credential Format Identifier is `dc+sd-jwt`.

#### [**A.3.2.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-A.3.2) **[Credential Issuer Metadata](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-credential-issuer-metadata-6)**

Cryptographic algorithm identifiers used in the `credential_signing_alg_values_supported` parameter are case sensitive strings and SHOULD be one of those JWS Algorithm Names defined in \[[IANA.JOSE](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#IANA.JOSE)\].

The following additional Credential Issuer metadata parameters are defined for this Credential Format for use in the `credential_configurations_supported` parameter, in addition to those defined in [Section 12.2.4](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#credential-issuer-parameters).

* `vct`: REQUIRED. String designating the type of the Credential, as defined in \[[I-D.ietf-oauth-sd-jwt-vc](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#I-D.ietf-oauth-sd-jwt-vc)\].
...
#### [**A.3.3.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-A.3.3) **[Authorization Details](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-authorization-details-5)**
...
#### [**A.3.4.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-A.3.4) **[Credential Response](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-credential-response-6)**
...
## [**Appendix B.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-B) **[Claims Description](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-claims-description)**
...
### [**B.1.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-B.1) **[Claims Description for Authorization Details](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-claims-description-for-auth)**
...
* `path`: REQUIRED. Non-empty array. Claim path pointer as defined in [Appendix C](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#claims_path_pointer) to identify the claim(s) in the Credential.  
...
The rules defined in [Appendix B.3](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#claims-description-processing) apply.

### [**B.2.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-B.2) **[Claims Description for Issuer Metadata](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-claims-description-for-issu)**

A claims description object as used in the Credential Issuer metadata is an object used to describe how a certain claim in the Credential is displayed to the End-User. It is used in the `claims` parameter in the Credential Issuer metadata defined in [Appendix A](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#format-profiles). The following keys can be used to describe the claim or claims:

* `path`: REQUIRED. The value MUST be a non-empty array representing a claims path pointer that specifies the path to a claim within the credential, as defined in [Appendix C](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#claims_path_pointer).  
...
* `display`: OPTIONAL. A non-empty array of objects, where each object contains display properties of a certain claim in the Credential for a certain language. Below is a non-exhaustive list of valid parameters that MAY be included:  
  ...
  * `locale`: OPTIONAL. String value that identifies the language of this object, represented as language tag values defined in BCP47 \[[RFC5646](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC5646)\]. There MUST be only one object for each language identifier.

The rules defined in [Appendix B.3](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#claims-description-processing) apply.

### [**B.3.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-B.3) **[Processing Rules for Claims Description Objects](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-processing-rules-for-claims)**
...
* there is a claims description object with a `path` that addresses a set of claims in an array (using `null`, as defined in [Appendix C](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#claims_path_pointer)) and another object that uses a non-negative integer to address a specific claim in the same array, or  
...
## [**Appendix C.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-C) **[Claims Path Pointer](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-claims-path-pointer)**
...
### [**C.1.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-C.1) **[Semantics for JSON-based credentials](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-semantics-for-json-based-cr)**
...
#### [**C.1.1.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-C.1.1) **[Processing](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-processing)**
...
### [**C.2.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-C.2) **[Semantics for ISO mdoc-based credentials](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-semantics-for-iso-mdoc-base)**
...
#### [**C.2.1.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-C.2.1) **[Processing](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-processing-2)**
...
### [**C.3.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-C.3) **[Claims Path Pointer Example](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-claims-path-pointer-example)**
...
## [**Appendix D.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-D) **[Key Attestations](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-key-attestations)**
...
### [**D.1.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-D.1) **[Key Attestation in JWT format](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-key-attestation-in-jwt-form)**
...
* in the JOSE header,  
  * `alg`: REQUIRED. A digital signature algorithm identifier such as per IANA "JSON Web Signature and Encryption Algorithms" registry \[[IANA.JOSE](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#IANA.JOSE)\]. It MUST NOT be `none` or an identifier for a symmetric algorithm (MAC).  
  * `typ`: REQUIRED. MUST be `key-attestation+jwt`, which explicitly types the key proof JWT as recommended in Section 3.11 of \[[RFC8725](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC8725)\].

The key attestation may use `x5c`, `kid` or `trust_chain` (as defined in [Appendix F.1](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#jwt-proof-type)) to convey the public key and the associated trust mechanism to sign the key attestation.

* in the JWT body,  
  * `iat`: REQUIRED (number). Integer for the time at which the key attestation was issued using the syntax defined in \[[RFC7519](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC7519)\].  
  * `exp`: OPTIONAL (number). Integer for the time at which the key attestation and the key(s) it is attesting expire, using the syntax defined in \[[RFC7519](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC7519)\]. MUST be present if the attestation is used with the JWT proof type.  
  * `attested_keys` : REQUIRED. A non-empty array of attested keys from the same key storage component using the syntax of JWK as defined in \[[RFC7517](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC7517)\].  
  * `key_storage` : OPTIONAL. A non-empty array of case sensitive strings that assert the attack potential resistance of the key storage component and its keys attested in the `attested_keys` parameter. This specification defines initial values in [Appendix D.2](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#keyattestation-apr).  
  * `user_authentication` : OPTIONAL. A non-empty array of case sensitive strings that assert the attack potential resistance of the user authentication methods allowed to access the private keys from the `attested_keys` parameter. This specification defines initial values in [Appendix D.2](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#keyattestation-apr).  
  ...
  * `status`: OPTIONAL. JSON Object representing the supported revocation check mechanisms, such as the one defined in \[[I-D.ietf-oauth-status-list](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#I-D.ietf-oauth-status-list)\]
...
### [**D.2.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-D.2) **[Attack Potential Resistance](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-attack-potential-resistance)**

This specification defines the following values for `key_storage` and `user_authentication`:

* `iso_18045_high`: It MUST be used when key storage or user authentication is resistant to attack with attack potential "High", equivalent to VAN.5 according to \[[ISO.18045](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#ISO.18045)\].  
* `iso_18045_moderate`: It MUST be used when key storage or user authentication is resistant to attack with attack potential "Moderate", equivalent to VAN.4 according to \[[ISO.18045](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#ISO.18045)\].  
* `iso_18045_enhanced-basic`: It MUST be used when key storage or user authentication is resistant to attack with attack potential "Enhanced-Basic", equivalent to VAN.3 according to \[[ISO.18045](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#ISO.18045)\].  
* `iso_18045_basic`: It MUST be used when key storage or user authentication is resistant to attack with attack potential "Basic", equivalent to VAN.2 according to \[[ISO.18045](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#ISO.18045)\].

Specifications that extend this list MUST choose collision-resistant values.

When \[[ISO.18045](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#ISO.18045)\] is not used, ecosystems may define their own values. If the value does not map to a well-known specification, it is RECOMMENDED that the value is a URL that gives further information about the attack potential resistance and possible relations to level of assurances.

## [**Appendix E.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-E) **[Wallet Attestations in JWT format](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-wallet-attestations-in-jwt-)**
...
The Wallet Attestation format follows Section 5.1 "Client Attestation JWT" of \[[I-D.ietf-oauth-attestation-based-client-auth](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#I-D.ietf-oauth-attestation-based-client-auth)\]. The Wallet Attestation additionally includes the following JWT Claims:
...
* `status`: OPTIONAL. Status mechanism for the Wallet Attestation as defined in \[[I-D.ietf-oauth-status-list](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#I-D.ietf-oauth-status-list)\]
...
See [Appendix I.2](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#wallet-attestation-example) for an example of a signed Wallet Attestation JWT.
...
The `sub` claim of the Wallet Attestation JWT is the `client_id` of the Wallet instance. For privacy reasons, this value is the same across Wallet instances of that Wallet Provider, see [Section 15.4.4](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#walletattestation-sub) for more details.

## [**Appendix F.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-F) **[Proof Types](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-proof-types)**
...
* `jwt`: A JWT \[[RFC7519](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC7519)\] is used for proof of possession. When a `proofs` object is using a `jwt` proof type, it MUST include a `jwt` parameter with its value being a non-empty array of JWTs, where each JWT is formed as defined in [Appendix F.1](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#jwt-proof-type).  
* `di_vp`: A W3C Verifiable Presentation object signed using the Data Integrity Proof \[[VC\_Data\_Integrity](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#VC_Data_Integrity)\] as defined in \[[VC\_DATA\_2.0](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#VC_DATA_2.0)\] or \[[VC\_DATA](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#VC_DATA)\] is used for proof of possession. When a `proofs` object is using a `di_vp` proof type, it MUST include an `di_vp` parameter with its value being a non-empty array of W3C Verifiable Presentations as defined by \[[VC\_DATA\_2.0](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#VC_DATA_2.0)\] or \[[VC\_DATA](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#VC_DATA)\], where each of these W3C Verifiable Presentation is formed as defined in [Appendix F.2](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#di-vp-proof-type).  
* `attestation`: A JWT \[[RFC7519](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC7519)\] representing a key attestation without using a proof of possession of the cryptographic key material that is being attested. When a `proofs` object is using an `attestation` proof type, the object MUST include an `attestation` parameter with its value being an array that contains exactly one JWT that is formed as defined in [Appendix D.1](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#keyattestation-jwt).

There are two ways to convey key attestations (as defined in [Appendix D](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#keyattestation)) of the cryptographic key material during Credential issuance:
...
### [**F.1.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-F.1) **[`jwt` Proof Type](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-jwt-proof-type)**

The JWT MUST contain the following elements:

* in the JOSE header,  
  * `alg`: REQUIRED. A digital signature algorithm identifier such as per IANA "JSON Web Signature and Encryption Algorithms" registry \[[IANA.JOSE](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#IANA.JOSE)\]. It MUST NOT be `none` or an identifier for a symmetric algorithm (MAC).  
  * `typ`: REQUIRED. MUST be `openid4vci-proof+jwt`, which explicitly types the key proof JWT as recommended in Section 3.11 of \[[RFC8725](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC8725)\].  
  ...
  * `key_attestation`: OPTIONAL. JOSE Header containing a key attestation as described in [Appendix D](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#keyattestation). If the Credential Issuer provided a `c_nonce`, the `nonce` claim in the key attestation MUST be set to a server-provided `c_nonce`.  
  * `trust_chain`: OPTIONAL. JOSE Header containing an \[[OpenID.Federation](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#OpenID.Federation)\] Trust Chain. This element MAY be used to convey key attestation, metadata, metadata policies, federation Trust Marks and any other information related to a specific federation, if available in the chain. When used for signature verification, the header parameter `kid` MUST be present.  
* in the JWT body,  
  ...
  * `iat`: REQUIRED (number). The value of this claim MUST be the time at which the key proof was issued using the syntax defined in \[[RFC7519](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC7519)\].  
  * `nonce`: OPTIONAL (string). The value type of this claim MUST be a string, where the value is a server-provided `c_nonce`. It MUST be present when the issuer has a Nonce Endpoint as defined in [Section 7](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#nonce-endpoint).
...
Cryptographic algorithm identifiers used in the `proof_signing_alg_values_supported` Credential Issuer metadata parameter for this proof type are case sensitive strings and SHOULD be one of the Algorithm Names defined in \[[IANA.JOSE](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#IANA.JOSE)\]. If Credential Issuer metadata is provided, the `alg` JWT header of the key proof, and if present, the `alg` JOSE headers of both `key_attestation` and `trust_chain`, MUST match one of the values listed in the `proof_signing_alg_values_supported` metadata parameter.
...
### [**F.2.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-F.2) **[`di_vp` Proof Type](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-di_vp-proof-type)**

When a W3C Verifiable Presentation as defined by \[[VC\_DATA\_2.0](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#VC_DATA_2.0)\] or \[[VC\_DATA](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#VC_DATA)\] secured using Data Integrity \[[VC\_Data\_Integrity](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#VC_Data_Integrity)\] is used as key proof, it MUST contain at least the following properties, in addition to any other properties required by \[[VC\_DATA\_2.0](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#VC_DATA_2.0)\] or \[[VC\_DATA](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#VC_DATA)\]:
...
* `proof`: REQUIRED. The `proof` property of the W3C Verifiable Presentation MUST be a Data Integrity Proof, as defined in \[[VC\_Data\_Integrity](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#VC_Data_Integrity)\], and its properties MUST conform with the following rules, in addition to those specified in \[[VC\_Data\_Integrity](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#VC_Data_Integrity)\]:
  ...
  * `challenge`: REQUIRED when the Credential Issuer has provided a `c_nonce`. It MUST NOT be used otherwise. String, where the value is a server-provided `c_nonce`. It MUST be present when the issuer has a Nonce Endpoint as defined in [Section 7](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#nonce-endpoint).
...
### [**F.3.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-F.3) **[`attestation` Proof Type](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-attestation-proof-type)**

A key attestation in JWT format as defined in [Appendix D.1](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#keyattestation-jwt).

If the Credential Issuer has a Nonce Endpoint (as defined in [Section 7](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#nonce-endpoint)), the `c_nonce` value provided by the Credential Issuer MUST be provided in the key attestation's `nonce` parameter.

Cryptographic algorithm identifiers used in the `proof_signing_alg_values_supported` Credential Issuer metadata parameter for this proof type are case sensitive strings and SHOULD be one of those defined in \[[IANA.JOSE](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#IANA.JOSE)\].
...
### [**F.4.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-F.4) **[Verifying Proof](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-verifying-proof)**

To validate a key proof, the Credential Issuer MUST ensure that:

* all required claims for that proof type are contained as defined in [Appendix F](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#proof-types),  
...
* the creation time of the JWT, as determined by either the issuance time, or a server managed timestamp via the nonce claim, is within an acceptable window (see [Section 13.8](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#key-proof-replay)).

These checks may be performed in any order.

## [**Appendix G.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-G) **[IANA Considerations](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-iana-considerations)**

### [**G.1.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-G.1) **[OAuth URI Registry](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-oauth-uri-registry)**

This specification registers the following URN in the IANA "OAuth URI" registry \[[IANA.OAuth.Parameters](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#IANA.OAuth.Parameters)\] established by \[[RFC6755](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC6755)\].

#### [**G.1.1.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-G.1.1) **[urn:ietf:params:oauth:grant-type:pre-authorized\_code](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-urnietfparamsoauthgrant-typ)**

* URN: `urn:ietf:params:oauth:grant-type:pre-authorized_code`  
* Common Name: Pre-Authorized Code  
* Change Controller: OpenID Foundation Digital Credentials Protocols Working Group \- openid-specs-digital-credentials-protocols@lists.openid.net  
* Reference: [Section 4.1.1](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#credential-offer-parameters) of this specification

### [**G.2.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-G.2) **[OAuth Parameters Registry](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-oauth-parameters-registry)**

This specification registers the following OAuth parameter in the IANA "OAuth Parameters" registry \[[IANA.OAuth.Parameters](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#IANA.OAuth.Parameters)\] established by \[[RFC6749](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC6749)\].

#### [**G.2.1.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-G.2.1) **[issuer\_state](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-issuer_state)**

* Name: `issuer_state`  
* Parameter Usage Location: authorization request  
* Change Controller: OpenID Foundation Digital Credentials Protocols Working Group \- openid-specs-digital-credentials-protocols@lists.openid.net  
* Reference: [Section 5.1](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#credential-authz-request) of this specification

#### [**G.2.2.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-G.2.2) **[pre-authorized\_code](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-pre-authorized_code)**

* Name: `pre-authorized_code`  
* Parameter Usage Location: token request  
* Change Controller: OpenID Foundation Digital Credentials Protocols Working Group \- openid-specs-digital-credentials-protocols@lists.openid.net  
* Reference: [Section 6.1](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#token-request) of this specification

#### [**G.2.3.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-G.2.3) **[tx\_code](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-tx_code)**
...
### [**G.3.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-G.3) **[OAuth Authorization Server Metadata Registry](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-oauth-authorization-server-)**

This specification registers the following authorization server metadata parameter in the IANA "OAuth Authorization Server Metadata" registry \[[IANA.OAuth.Parameters](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#IANA.OAuth.Parameters)\] established by \[[RFC8414](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC8414)\].

#### [**G.3.1.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-G.3.1) **[pre-authorized\_grant\_anonymous\_access\_supported](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-pre-authorized_grant_anonym)**
...
* Change Controller: OpenID Foundation Digital Credentials Protocols Working Group \- openid-specs-digital-credentials-protocols@lists.openid.net  
* Reference: [Section 12.3](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#as-metadata) of this specification

### [**G.4.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-G.4) **[OAuth Dynamic Client Registration Metadata Registry](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-oauth-dynamic-client-regist)**

This specification registers the following client metadata parameter in the IANA "OAuth Dynamic Client Registration Metadata" registry \[[IANA.OAuth.Parameters](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#IANA.OAuth.Parameters)\] established by \[[RFC7591](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC7591)\].

#### [**G.4.1.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-G.4.1) **[credential\_offer\_endpoint](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-credential_offer_endpoint)**

* Client Metadata Name: `credential_offer_endpoint`  
* Client Metadata Description: Credential Offer Endpoint  
* Change Controller: OpenID Foundation Digital Credentials Protocols Working Group \- openid-specs-digital-credentials-protocols@lists.openid.net  
* Reference: [Section 12.1](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#client-metadata) of this specification

### [**G.5.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-G.5) **[Well-Known URI Registry](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-well-known-uri-registry)**

This specification registers the following well-known URI in the IANA "Well-Known URI" registry \[[IANA.Well-Known.URIs](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#IANA.Well-Known.URIs)\] established by \[[RFC8615](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC8615)\].

#### [**G.5.1.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-G.5.1) **[.well-known/openid-credential-issuer](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-well-known-openid-credentia)**

* URI suffix: `openid-credential-issuer`  
* Change controller: OpenID Foundation Digital Credentials Protocols Working Group \- openid-specs-digital-credentials-protocols@lists.openid.net  
* Specification document: [Section 12.2.2](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#credential-issuer-wellknown) of this specification  
* Related information: (none)

### [**G.6.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-G.6) **[Media Types Registry](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-media-types-registry)**

This specification registers the following media type \[[RFC2046](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC2046)\] in the IANA "Media Types" registry \[[IANA.MediaTypes](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#IANA.MediaTypes)\] in the manner described in \[[RFC6838](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC6838)\].

#### [**G.6.1.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-G.6.1) **[application/openid4vci-proof+jwt](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-application-openid4vci-proo)**

* Type name: `application`  
* Subtype name: `openid4vci-proof+jwt`  
* Required parameters: n/a  
* Optional parameters: n/a  
* Encoding considerations: Uses JWS Compact Serialization, as specified in \[[RFC7515](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC7515)\].  
* Security considerations: See the Security Considerations in \[[RFC7519](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC7519)\].  
* Interoperability considerations: n/a  
* Published specification: [Appendix F.1](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#jwt-proof-type) of this specification  
...
#### [**G.6.2.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-G.6.2) **[application/key-attestation+jwt](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-application-key-attestation)**
...
* Security considerations: See the Security Considerations in \[[RFC7519](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC7519)\].  
* Interoperability considerations: n/a  
* Published specification: [Appendix D.1](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#keyattestation-jwt) of this specification  
...
#### [**G.6.3.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-G.6.3) **[application/openidvci-issuer-metadata+jwt](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-application-openidvci-issue)**
...
* Security considerations: See the Security Considerations in \[[RFC7519](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#RFC7519)\].  
* Interoperability considerations: n/a  
* Published specification: [Section 12.2.3](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#credential-issuer-signed-metadata) of this specification  
...
### [**G.7.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-G.7) **[Uniform Resource Identifier (URI) Schemes Registry](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-uniform-resource-identifier)**

This specification registers the following URI scheme in the IANA "Uniform Resource Identifier (URI) Schemes" registry \[[IANA.URI.Schemes](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#IANA.URI.Schemes)\].

#### [**G.7.1.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-G.7.1) **[openid-credential-offer](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-openid-credential-offer)**
...
* Change Controller: OpenID Foundation Digital Credentials Protocols Working Group \- openid-specs-digital-credentials-protocols@lists.openid.net  
* Reference: [Section 12.1.1](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#client-metadata-retrieval) of this specification

## [**Appendix H.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-H) **[Use Cases](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-use-cases)**

This is a non-exhaustive list of sample use cases.

### [**H.1.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-H.1) **[Credential Offer \- Same-Device](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-credential-offer-same-devic)**
...
### [**H.2.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-H.2) **[Credential Offer \- Cross-Device (with Information Pre-Submitted by the End-User)](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-credential-offer-cross-devi)**
...
### [**H.3.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-H.3) **[Credential Offer \- Cross-Device & Deferred](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-credential-offer-cross-devic)**
...
### [**H.4.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-H.4) **[Wallet-Initiated Issuance during Presentation](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-wallet-initiated-issuance-d)**
...
### [**H.5.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-H.5) **[Wallet-Initiated Issuance during Presentation (Requires Presentation of Additional Credentials During Issuance)](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-wallet-initiated-issuance-du)**
...
### [**H.6.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-H.6) **[Wallet-Initiated Issuance after Installation](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-wallet-initiated-issuance-a)**
...
## [**Appendix I.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-I) **[Additional Examples](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-additional-examples)**

### [**I.1.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-I.1) **[Credential Issuer Metadata](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-credential-issuer-metadata-7)**

This section contains additional examples for Credential issuer Metadata

The following is a non-normative example of Credential Issuer metadata of a Credential in the IETF SD-JWT VC \[[I-D.ietf-oauth-sd-jwt-vc](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#I-D.ietf-oauth-sd-jwt-vc)\] format in signed form (JWT):
...
The following is a non-normative example of Credential Issuer metadata of a Credential in the IETF SD-JWT VC \[[I-D.ietf-oauth-sd-jwt-vc](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#I-D.ietf-oauth-sd-jwt-vc)\] format with optional parameters present:
...
### [**I.2.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-I.2) **[Wallet Attestation JWT](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-wallet-attestation-jwt)**
...
## [**Appendix J.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-J) **[Acknowledgements](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-acknowledgements)**
...
## [**Appendix K.**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#appendix-K) **[Notices](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-notices)**
...
## [**Authors' Addresses**](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html#name-authors-addresses)
