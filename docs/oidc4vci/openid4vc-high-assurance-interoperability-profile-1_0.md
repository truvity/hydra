...
## [**Abstract**](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#abstract)

This specification defines a profile of OpenID for Verifiable Credentials in combination with the credential formats IETF SD-JWT VC \[[I-D.ietf-oauth-sd-jwt-vc](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#I-D.ietf-oauth-sd-jwt-vc)\] and ISO mdoc \[[ISO.18013-5](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#ISO.18013-5)\]. The aim is to select features and to define a set of requirements for the existing specifications to enable interoperability among Issuers, Wallets, and Verifiers of Credentials where a high level of security and privacy is required. The profiled specifications include OpenID for Verifiable Credential Issuance \[[OIDF.OID4VCI](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#OIDF.OID4VCI)\], OpenID for Verifiable Presentations \[[OIDF.OID4VP](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#OIDF.OID4VP)\], IETF SD-JWT VC \[[I-D.ietf-oauth-sd-jwt-vc](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#I-D.ietf-oauth-sd-jwt-vc)\], and ISO mdoc \[[ISO.18013-5](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#ISO.18013-5)\].

## [**1\.**](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#section-1) **[Introduction](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#name-introduction)**
...
### [**1.1.**](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#section-1.1) **[Target Audience/Usage](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#name-target-audience-usage)**
...
### [**1.2.**](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#section-1.2) **[Errata Revisions](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#name-errata-revisions)**

The latest revision of this specification, incorporating any errata updates, is published at [openid4vc-high-assurance-interoperability-profile-1\_0](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html). The text of the final specification as approved will always be available at [openid4vc-high-assurance-interoperability-profile-1\_0-final](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0-final.html). When referring to this specification from other documents, it is recommended to reference [openid4vc-high-assurance-interoperability-profile-1\_0](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html).

### [**1.3.**](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#section-1.3) **[Requirements Notation and Conventions](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#name-requirements-notation-and-c)**
...
## [**2\.**](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#section-2) **[Terminology](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#name-terminology)**
...
## [**3\.**](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#section-3) **[Scope](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#name-scope)**
...
### [**3.1.**](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#section-3.1) **[Assumptions](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#name-assumptions)**
...
### [**3.2.**](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#section-3.2) **[Additional scenarios](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#name-additional-scenarios)**
...
### [**3.3.**](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#section-3.3) **[Standards Requirements](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#name-standards-requirements)**
...
* W3C Digital Credentials API \[[w3c.digital\_credentials\_api](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#w3c.digital_credentials_api)\]  
...
### [**3.4.**](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#section-3.4) **[Out of Scope](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#name-out-of-scope)**
...
## [**4\.**](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#section-4) **[OpenID for Verifiable Credential Issuance](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#name-openid-for-verifiable-crede)**
...
The following aspects of \[[FAPI2\_Security\_Profile](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#FAPI2_Security_Profile)\] do not apply to this specification:
...
Note that some optional parts of \[[FAPI2\_Security\_Profile](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#FAPI2_Security_Profile)\] are not applicable when using only OpenID for Verifiable Credential Issuance, e.g., MTLS or OpenID Connect.
...
### [**4.1.**](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#section-4.1) **[Issuer Metadata](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#name-issuer-metadata)**
...
The Credential Issuer MUST support metadata retrieval according to Section 12.2.2 of \[[OIDF.OID4VCI](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#OIDF.OID4VCI)\]. The Credential Issuer metadata MUST include a scope for every Credential Configuration it supports.

When Ecosystem policies require Issuer Authentication to a higher level than possible with TLS alone, signed Credential Issuer Metadata as specified in Section 11.2.3 in \[[OIDF.OID4VCI](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#OIDF.OID4VCI)\] MUST be supported by both the Wallet and the Issuer. Key resolution to validate the signed Issuer Metadata MUST be supported using the `x5c` JOSE header parameter as defined in \[[RFC7515](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#RFC7515)\]. In this case, the X.509 certificate of the trust anchor MUST NOT be included in the `x5c` JOSE header of the signed request. The X.509 certificate signing the request MUST NOT be self-signed.
...
### [**4.2.**](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#section-4.2) **[Credential Offer](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#name-credential-offer)**
...
### [**4.3.**](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#section-4.3) **[Authorization Endpoint](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#name-authorization-endpoint)**
...
### [**4.4.**](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#section-4.4) **[Token Endpoint](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#name-token-endpoint)**
...
#### [**4.4.1.**](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#section-4.4.1) **[Wallet Attestation](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#name-wallet-attestation)**
...
### [**4.5.**](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#section-4.5) **[Credential Endpoint](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#name-credential-endpoint)**

#### [**4.5.1.**](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#section-4.5.1) **[Key Attestation](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#name-key-attestation)**
...
## [**5\.**](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#section-5) **[OpenID for Verifiable Presentations](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#name-openid-for-verifiable-prese)**
...
### [**5.1.**](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#section-5.1) **[OpenID for Verifiable Presentations via Redirects](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#name-openid-for-verifiable-presen)**
...
### [**5.2.**](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#section-5.2) **[OpenID for Verifiable Presentations via W3C Digital Credentials API](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#name-openid-for-verifiable-present)**
...
### [**5.3.**](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#section-5.3) **[Requirements specific to Credential Formats](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#name-requirements-specific-to-cr)**

#### [**5.3.1.**](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#section-5.3.1) **[ISO Mobile Documents or mdocs (ISO/IEC 18013 and ISO/IEC 23220 series)](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#name-iso-mobile-documents-or-mdo)**
...
#### [**5.3.2.**](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#section-5.3.2) **[IETF SD-JWT VC](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#name-ietf-sd-jwt-vc)**
...
## [**6\.**](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#section-6) **[OpenID4VC Credential Format Profiles](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#name-openid4vc-credential-format)**
...
### [**6.1.**](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#section-6.1) **[IETF SD-JWT VC Profile](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#name-ietf-sd-jwt-vc-profile)**
...
#### [**6.1.1.**](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#section-6.1.1) **[Issuer identification and key resolution to validate an issued Credential](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#name-issuer-identification-and-k)**
...
##### [**6.1.1.1.**](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#section-6.1.1.1) **[Cryptographic Holder Binding between VC and VP](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#name-cryptographic-holder-bindin)**
...
## [**7\.**](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#section-7) **[Requirements for Digital Signatures](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#name-requirements-for-digital-si)**
...
## [**8\.**](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#section-8) **[Hash Algorithms](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#name-hash-algorithms)**
...
## [**9\.**](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#section-9) **[Implementation Considerations](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#name-implementation-consideratio)**

### [**9.1.**](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#section-9.1) **[Requirements for browser/OS support of specific features](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#name-requirements-for-browser-os)**
...
### [**9.2.**](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#section-9.2) **[Interoperable Key Attestations](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#name-interoperable-key-attestati)**

Wallet implementations using the key attestation format specified in Appendix D of \[[OIDF.OID4VCI](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#OIDF.OID4VCI)\] might need to utilize a transformation (backend) service to create such attestations based on data as provided in other formats by the respective platform or secure key management module. The dependency on such a service might impact the availability of the wallet app as well as the performance of the issuance process. This could be mitigated by creating keys and obtaining the respective key attestations in advance.

### [**9.3.**](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#section-9.3) **[Ecosystem Implementation Considerations](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#name-ecosystem-implementation-co)**
...
* Which flow(s) to adopt: presentation, issuance, or both (see [Section 3](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#scope))  
* For presentation, whether to use the W3C Digital Credentials API, Redirects with custom URL schemes, and/or Redirects with claimed `https` scheme URIs (see [Section 3](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#scope))  
* Which Credential Format to support across issuance and presentation (see [Section 3](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#scope))  
* Whether to use Signed Issuer Metadata or not (see [Section 4.1](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#issuer-metadata))  
* How to make a Credential Offer available to the Wallet (see [Section 4.2](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#credential-offer))  
* Which Key Attestation format to use (see [Section 4.5.1](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#key-attestation))  
* Which Wallet Attestation format to use (see [Section 4.4.1](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#wallet-attestation))  
* Which X.509 certificate profile to use (see [Section 5](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#openid-for-verifiable-presentations), [Section 4.4.1](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#wallet-attestation) and [Section 4.5.1](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#key-attestation))  
* Support or restriction of additional cryptographic suites and hash algorithms (see [Section 7](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#crypto-suites))

#### [**9.3.1.**](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#section-9.3.1) **[Non-normative Examples of Ecosystem-specific Extensions of this Specification](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#name-non-normative-examples-of-e)**
...
##### [**9.3.1.1.**](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#section-9.3.1.1) **[Example 1: Baseline Interoperability without pre-existing relationships](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#name-example-1-baseline-interope)**
...
* For issuance, the following requirements apply:  
  ...
  * Wallets and Issuers both support Key Attestations in the format specified in Appendix D of \[[OIDF.OID4VCI](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#OIDF.OID4VCI)\]. Both `jwt` proof type using `key_attestation` and `attestation` proof type are supported.  
  * Wallets and Issuers both support Wallet Attestations in the format specified in Appendix E of \[[OIDF.OID4VCI](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#OIDF.OID4VCI)\] and [Section 4.4.1](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#wallet-attestation) of this specification.  
...
Making these choices maximizes interoperability between the parties in the Ecosystem while minimizing the burden on Issuers and Verifiers. This comes at the expense of an increased burden on Wallets as well as the potential privacy and security issues in [Section 11.1](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#interop-key-attestations).

##### [**9.3.1.2.**](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#section-9.3.1.2) **[Example 2: Achieving Compatibility with Existing Deployments of ISO/IEC 18013-5](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#name-example-2-achieving-compati)**
...
* Use this specification only for presentation with the following requirements:  
  ...
  * As X.509 certificate profile, Wallets and Verifiers use the Reader Authentication Certificate profile defined in Annex B of \[[ISO.18013-5](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#ISO.18013-5)\].  
  * Verifiers support all curves from Cipher Suite 1 listed in table 22 of \[[ISO.18013-5](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#ISO.18013-5)\].  
  * Verifiers support all hash algorithms listed in table 21 of \[[ISO.18013-5](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#ISO.18013-5)\].

Making these choices ensures interoperability at the increased cost on the Verifier.

### [**9.4.**](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#section-9.4) **[Pre-Final Specifications](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#name-pre-final-specifications)**
...
* SD-JWT-based Verifiable Credentials (SD-JWT VC) draft \-13 \[[I-D.ietf-oauth-sd-jwt-vc](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#I-D.ietf-oauth-sd-jwt-vc)\]  
* Token Status List draft \-14 \[[I-D.ietf-oauth-status-list](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#I-D.ietf-oauth-status-list)\]
...
Note that specification versions mentioned in this specification overwrite the versions previously mentioned in \[[OIDF.OID4VCI](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#OIDF.OID4VCI)\] and \[[OIDF.OID4VP](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#OIDF.OID4VP)\].

## [**10\.**](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#section-10) **[Security Considerations](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#name-security-considerations)**

Note that security considerations for OpenID for Verifiable Credential Issuance are defined in Section 13 of \[[OIDF.OID4VCI](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#OIDF.OID4VCI)\] and for OpenID for Verifiable Presentations in Section 14 (for redirect based flows) or Section A.5 (for DC API) of \[[OIDF.OID4VP](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#OIDF.OID4VP)\].

### [**10.1.**](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#section-10.1) **[Incomplete or Incorrect Implementations of the Specifications and Conformance Testing](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#name-incomplete-or-incorrect-imp)**
...
[https://openid.net/certification/conformance-testing-for-openid-for-verifiable-credential-issuance/](https://openid.net/certification/conformance-testing-for-openid-for-verifiable-credential-issuance/)
...
### [**10.2.**](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#section-10.2) **[Key sizes](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#name-key-sizes)**

Implementers need to ensure appropriate key sizes are used. Guidance can be found in, for example, \[[NIST.SP.800-131A](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#NIST.SP.800-131A)\], \[[NIST.SP.800-57](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#NIST.SP.800-57)\], \[[BSI.TR-02102-1](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#BSI.TR-02102-1)\], or \[[ECCG.ACM2](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#ECCG.ACM2)\].

## [**11\.**](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#section-11) **[Privacy Considerations](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#name-privacy-considerations)**

Note that privacy considerations for OpenID for Verifiable Credential Issuance are defined in Section 15 of \[[OIDF.OID4VCI](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#OIDF.OID4VCI)\] and for OpenID for Verifiable Presentations in Section 15 (for redirect based flows) or Section A.6 (for DC API) of \[[OIDF.OID4VP](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#OIDF.OID4VP)\].

### [**11.1.**](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#section-11.1) **[Interoperable Key Attestations](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#name-interoperable-key-attestatio)**
...
## [**12\.**](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#section-12) **[Normative References](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#name-normative-references)**
...
Terbu, O., Fett, D., and B. Campbell, "SD-JWT-based Verifiable Credentials (SD-JWT VC)", Work in Progress, Internet-Draft, draft-ietf-oauth-sd-jwt-vc-13, 6 November 2025, \<[https://datatracker.ietf.org/doc/html/draft-ietf-oauth-sd-jwt-vc-13](https://datatracker.ietf.org/doc/html/draft-ietf-oauth-sd-jwt-vc-13)\>.

**\[I-D.ietf-oauth-status-list\]**  
Looker, T., Bastian, P., and C. Bormann, "Token Status List (TSL)", Work in Progress, Internet-Draft, draft-ietf-oauth-status-list-14, 10 December 2025, \<[https://datatracker.ietf.org/doc/html/draft-ietf-oauth-status-list-14](https://datatracker.ietf.org/doc/html/draft-ietf-oauth-status-list-14)\>.

**\[ISO.18013-5\]**  
ISO/IEC JTC 1/SC 17 Cards and security devices for personal identification, "ISO/IEC 18013-5:2021 Personal identification — ISO-compliant driving license — Part 5: Mobile driving license (mDL) application", 2021, \<[https://www.iso.org/standard/69084.html](https://www.iso.org/standard/69084.html)\>.

**\[ISO.18013-5.second.edition\]**  
ISO/IEC JTC 1/SC 17 Cards and security devices for personal identification, "ISO/IEC 18013-5:xxxx Personal identification — ISO-compliant driving license — Part 5: Mobile driving license (mDL) application edition 2", \<[https://www.iso.org/standard/91081.html](https://www.iso.org/standard/91081.html)\>.

**\[OIDF.OID4VCI\]**  
Lodderstedt, T., Yasuda, K., Looker, T., and P. Bastian, "OpenID for Verifiable Credential Issuance 1.0", 16 September 2025, \<[https://openid.net/specs/openid-4-verifiable-credential-issuance-1\_0.html](https://openid.net/specs/openid-4-verifiable-credential-issuance-1_0.html)\>.

**\[OIDF.OID4VP\]**  
Terbu, O., Lodderstedt, T., Yasuda, K., Fett, D., and J. Heenan, "OpenID for Verifiable Presentations 1.0", 9 July 2025, \<[https://openid.net/specs/openid-4-verifiable-presentations-1\_0.html](https://openid.net/specs/openid-4-verifiable-presentations-1_0.html)\>.

**\[OIDF.ekyc-ida\]**  
yes, Fett, D., Haine, M., Pulido, A., Lehmann, K., and K. Koiwai, "OpenID Connect for Identity Assurance 1.0", 1 October 2024, \<[https://openid.net/specs/openid-connect-4-identity-assurance-1\_0.html](https://openid.net/specs/openid-connect-4-identity-assurance-1_0.html)\>.
...
**\[RFC9901\]**  
Fett, D., Yasuda, K., and B. Campbell, "Selective Disclosure for JSON Web Tokens", RFC 9901, DOI 10.17487/RFC9901, November 2025, \<[https://www.rfc-editor.org/info/rfc9901](https://www.rfc-editor.org/info/rfc9901)\>.

## [**13\.**](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#section-13) **[Informative References](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#name-informative-references)**

**\[BSI.TR-02102-1\]**  
Federal Office for Information Security (BSI), "Cryptographic Mechanisms: Recommendations and Key Lengths", January 2025, \<[https://www.bsi.bund.de/SharedDocs/Downloads/EN/BSI/Publications/TechGuidelines/TG02102/BSI-TR-02102-1.pdf?\_\_blob=publicationFile](https://www.bsi.bund.de/SharedDocs/Downloads/EN/BSI/Publications/TechGuidelines/TG02102/BSI-TR-02102-1.pdf?__blob=publicationFile)\>.

**\[ECCG.ACM2\]**  
European Cybersecurity Certification Group, Sub-group on Cryptography, "Agreed Cryptographic Mechanisms 2.0", April 2025, \<[https://certification.enisa.europa.eu/document/download/a845662b-aee0-484e-9191-890c4cfa7aaa\_en](https://certification.enisa.europa.eu/document/download/a845662b-aee0-484e-9191-890c4cfa7aaa_en)\>.

**\[ETSI.TL\]**  
European Telecommunications Standards Institute (ETSI), "ETSI TS 119 612 V2.4.1 Electronic Signatures and Trust Infrastructures (ESI); Trusted Lists", August 2025, \<[https://www.etsi.org/deliver/etsi\_ts/119600\_119699/119612/02.04.01\_60/ts\_119612v020401p.pdf](https://www.etsi.org/deliver/etsi_ts/119600_119699/119612/02.04.01_60/ts_119612v020401p.pdf)\>.
...
**\[NIST.SP.800-131A\]**  
Barker, E. and A. Roginsky, "NIST SP 800-131A: Transitioning the Use of Cryptographic Algorithms and Key Lengths", March 2019, \<[https://csrc.nist.gov/pubs/sp/800/131/a/r2/final](https://csrc.nist.gov/pubs/sp/800/131/a/r2/final)\>.

**\[NIST.SP.800-57\]**  
Barker, E., "NIST SP 800-57 Part 1: Recommendation for Key Management: Part 1 – General", May 2020, \<[https://csrc.nist.gov/pubs/sp/800/57/pt1/r5/final](https://csrc.nist.gov/pubs/sp/800/57/pt1/r5/final)\>.

**\[eIDAS2.0\]**  
European Union, "REGULATION (EU) 2024/1183 OF THE EUROPEAN PARLIAMENT AND OF THE COUNCIL of 11 April 2024 amending Regulation (EU) No 910/2014 as regards establishing the European Digital Identity Framework", 2024, \<[https://eur-lex.europa.eu/legal-content/EN/TXT/HTML/?uri=OJ:L\_202401183](https://eur-lex.europa.eu/legal-content/EN/TXT/HTML/?uri=OJ:L_202401183)\>.

**\[w3c.digital\_credentials\_api\]**  
Caceres, M., Cappalli, T., and M. A. Yosef, "Digital Credentials API", 8 December 2025, \<[https://www.w3.org/TR/2025/WD-digital-credentials-20251208/](https://www.w3.org/TR/2025/WD-digital-credentials-20251208/)\>.

## [**Appendix A.**](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#appendix-A) **[IANA Considerations](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#name-iana-considerations)**

### [**A.1.**](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#appendix-A.1) **[Uniform Resource Identifier (URI) Schemes Registry](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#name-uniform-resource-identifier)**

This specification registers the following URI schemes in the IANA "Uniform Resource Identifier (URI) Schemes" registry \[[IANA.URI.Schemes](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#IANA.URI.Schemes)\].

#### [**A.1.1.**](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#appendix-A.1.1) **[haip-vci](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#name-haip-vci)**
...
* Reference: [Section 4.2](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#credential-offer) of this specification

#### [**A.1.2.**](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#appendix-A.1.2) **[haip-vp](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#name-haip-vp)**
...
* Contact: OpenID Foundation Digital Credentials Protocols Working Group \- openid-specs-digital-credentials-protocols@lists.openid.net  
* Change Controller: OpenID Foundation Digital Credentials Protocols Working Group \- openid-specs-digital-credentials-protocols@lists.openid.net  
* Reference: [Section 5.1](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#oid4vp-redirects) of this specification

## [**Appendix B.**](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#appendix-B) **[Acknowledgements](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#name-acknowledgements)**
...
## [**Appendix C.**](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#appendix-C) **[Notices](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#name-notices)**
...
## [**Authors' Addresses**](https://openid.net/specs/openid4vc-high-assurance-interoperability-profile-1_0.html#name-authors-addresses)
