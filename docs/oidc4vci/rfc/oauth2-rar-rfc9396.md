...
## [**Abstract**](https://www.rfc-editor.org/rfc/rfc9396.html#abstract)
...
## [**Status of This Memo**](https://www.rfc-editor.org/rfc/rfc9396.html#name-status-of-this-memo)

This is an Internet Standards Track document.

This document is a product of the Internet Engineering Task Force (IETF). It represents the consensus of the IETF community. It has received public review and has been approved for publication by the Internet Engineering Steering Group (IESG). Further information on Internet Standards is available in Section 2 of RFC 7841\.

Information about the current status of this document, any errata, and how to provide feedback on it may be obtained at [https://www.rfc-editor.org/info/rfc9396](https://www.rfc-editor.org/info/rfc9396).

## [**Copyright Notice**](https://www.rfc-editor.org/rfc/rfc9396.html#name-copyright-notice)
...
## [**1\.**](https://www.rfc-editor.org/rfc/rfc9396.html#section-1) **[Introduction](https://www.rfc-editor.org/rfc/rfc9396.html#name-introduction)**

"The OAuth 2.0 Authorization Framework" \[[RFC6749](https://www.rfc-editor.org/rfc/rfc9396.html#RFC6749)\] defines the `scope` parameter that allows OAuth clients to specify the requested scope, i.e., the limited capability, of an access token. This mechanism is sufficient to implement static scenarios and coarse-grained authorization requests, such as "give me read access to the resource owner's profile." However, it is not sufficient to specify fine-grained authorization requirements, such as "please let me transfer an amount of 45 Euros to Merchant A" or "please give me read access to directory A and write access to file X."

This specification introduces a new parameter `authorization_details` that allows clients to specify their fine-grained authorization requirements using the expressiveness of JSON \[[RFC8259](https://www.rfc-editor.org/rfc/rfc9396.html#RFC8259)\] data structures.
...
[*Figure 1*](https://www.rfc-editor.org/rfc/rfc9396.html#figure-1)*: [Example of an Authorization Request for a Credit Transfer](https://www.rfc-editor.org/rfc/rfc9396.html#name-example-of-an-authorization)*  
...
For a comprehensive discussion of the challenges arising from new use cases in the open banking and electronic signing spaces, see \[[Transaction-Auth](https://www.rfc-editor.org/rfc/rfc9396.html#Transaction-Auth)\].
...
### [**1.1.**](https://www.rfc-editor.org/rfc/rfc9396.html#section-1.1) **[Conventions and Terminology](https://www.rfc-editor.org/rfc/rfc9396.html#name-conventions-and-terminology)**

The key words "**MUST**", "**MUST NOT**", "**REQUIRED**", "**SHALL**", "**SHALL NOT**", "**SHOULD**", "**SHOULD NOT**", "**RECOMMENDED**", "**NOT RECOMMENDED**", "**MAY**", and "**OPTIONAL**" in this document are to be interpreted as described in BCP 14 \[[RFC2119](https://www.rfc-editor.org/rfc/rfc9396.html#RFC2119)\] \[[RFC8174](https://www.rfc-editor.org/rfc/rfc9396.html#RFC8174)\] when, and only when, they appear in all capitals, as shown here.

This specification uses the terms "access token", "refresh token", "authorization server" (AS), "resource server" (RS), "authorization endpoint", "authorization request", "authorization response", "token endpoint", "grant type", "access token request", "access token response", and "client" defined by "[The OAuth 2.0 Authorization Framework](https://www.rfc-editor.org/rfc/rfc9396.html#RFC6749)" \[[RFC6749](https://www.rfc-editor.org/rfc/rfc9396.html#RFC6749)\].

## [**2\.**](https://www.rfc-editor.org/rfc/rfc9396.html#section-2) **[Request Parameter "authorization\_details"](https://www.rfc-editor.org/rfc/rfc9396.html#name-request-parameter-authoriza)**
...
[Figure 2](https://www.rfc-editor.org/rfc/rfc9396.html#figure2) shows an `authorization_details` of type `payment_initiation` using the example data shown above:
...
[*Figure 2*](https://www.rfc-editor.org/rfc/rfc9396.html#figure-2)*: [Example of "authorization\_details" for a Credit Transfer](https://www.rfc-editor.org/rfc/rfc9396.html#name-example-of-authorization_de)*  
[Figure 3](https://www.rfc-editor.org/rfc/rfc9396.html#figure3) shows a combined request asking for access to account information and permission to initiate a payment:
...
[*Figure 3*](https://www.rfc-editor.org/rfc/rfc9396.html#figure-3)*: [Example of "authorization\_details" for a Combined Request](https://www.rfc-editor.org/rfc/rfc9396.html#name-example-of-authorization_det)*  
...
Note: The AS will make this data subsequently available to the respective RSs (see [Section 9](https://www.rfc-editor.org/rfc/rfc9396.html#resource_servers)).

### [**2.1.**](https://www.rfc-editor.org/rfc/rfc9396.html#section-2.1) **[Authorization Details Types](https://www.rfc-editor.org/rfc/rfc9396.html#name-authorization-details-types)**

The AS controls the interpretation of the value of the `type` parameter as well as the object fields that the `type` parameter allows. However, the value of the `type` parameter is also generally documented and intended to be used by developers. It is **RECOMMENDED** that API designers choose `type` values that are easily copied without ambiguity. For example, some glyphs have multiple Unicode code points for the same visual character, and a developer could potentially type a different character than what the AS has defined. Possible means of reducing potential confusion are limiting the value to ASCII \[[RFC0020](https://www.rfc-editor.org/rfc/rfc9396.html#RFC0020)\] characters, providing a machine-readable listing of data type values, or instructing developers to copy and paste directly from the documentation.
...
[*Figure 4*](https://www.rfc-editor.org/rfc/rfc9396.html#figure-4)*: [Example of "authorization\_details" with a URL as Type Identifier](https://www.rfc-editor.org/rfc/rfc9396.html#name-example-of-authorization_deta)*

### [**2.2.**](https://www.rfc-editor.org/rfc/rfc9396.html#section-2.2) **[Common Data Fields](https://www.rfc-editor.org/rfc/rfc9396.html#name-common-data-fields)**
...
`locations`:  
An array of strings representing the location of the resource or RS. These strings are typically URIs identifying the location of the RS. This field can allow a client to specify a particular RS, as discussed in [Section 12](https://www.rfc-editor.org/rfc/rfc9396.html#security_considerations).
...
[*Figure 5*](https://www.rfc-editor.org/rfc/rfc9396.html#figure-5)*: [Example of "authorization\_details" with Common Data Fields](https://www.rfc-editor.org/rfc/rfc9396.html#name-example-of-authorization_detai)*  
...
[*Figure 6*](https://www.rfc-editor.org/rfc/rfc9396.html#figure-6)*: [Example of "authorization\_details" with Common Data Fields in Multiple Objects](https://www.rfc-editor.org/rfc/rfc9396.html#name-example-of-authorization_detail)*  
...
[*Figure 7*](https://www.rfc-editor.org/rfc/rfc9396.html#figure-7)*: [Example of "authorization\_details" Using Common and Extension Data Fields](https://www.rfc-editor.org/rfc/rfc9396.html#name-example-of-authorization_details)*  
...
## [**3\.**](https://www.rfc-editor.org/rfc/rfc9396.html#section-3) **[Authorization Request](https://www.rfc-editor.org/rfc/rfc9396.html#name-authorization-request)**
...
* authorization requests as specified in \[[RFC6749](https://www.rfc-editor.org/rfc/rfc9396.html#RFC6749)\]  
* device authorization requests as specified in \[[RFC8628](https://www.rfc-editor.org/rfc/rfc9396.html#RFC8628)\]  
* backchannel authentication requests as defined in \[[OID-CIBA](https://www.rfc-editor.org/rfc/rfc9396.html#OID-CIBA)\]

In case of authorization requests as defined in \[[RFC6749](https://www.rfc-editor.org/rfc/rfc9396.html#RFC6749)\], implementers **MAY** consider using pushed authorization requests \[[RFC9126](https://www.rfc-editor.org/rfc/rfc9396.html#RFC9126)\] to improve the security, privacy, and reliability of the flow. See Sections [12](https://www.rfc-editor.org/rfc/rfc9396.html#security_considerations), [13](https://www.rfc-editor.org/rfc/rfc9396.html#privacy_considerations), and [11.4](https://www.rfc-editor.org/rfc/rfc9396.html#large_requests) for details.

Parameter encoding is determined by the respective context. In the context of an authorization request according to \[[RFC6749](https://www.rfc-editor.org/rfc/rfc9396.html#RFC6749)\], the parameter is encoded using the `application/x-www-form-urlencoded` format of the serialized JSON as shown in [Figure 8](https://www.rfc-editor.org/rfc/rfc9396.html#fig8), using the example from [Section 2](https://www.rfc-editor.org/rfc/rfc9396.html#authz_details) (line breaks for display purposes only):
...
[*Figure 8*](https://www.rfc-editor.org/rfc/rfc9396.html#figure-8)*: [Example of Authorization Request with "authorization\_details"](https://www.rfc-editor.org/rfc/rfc9396.html#name-example-of-authorization-re)*  
...
In [Figure 9](https://www.rfc-editor.org/rfc/rfc9396.html#fig9), the client wants to get access to account information and initiate a payment:
...
[*Figure 9*](https://www.rfc-editor.org/rfc/rfc9396.html#figure-9)*: [URL Decoded "authorization\_details"](https://www.rfc-editor.org/rfc/rfc9396.html#name-url-decoded-authorization_d)*

### [**3.1.**](https://www.rfc-editor.org/rfc/rfc9396.html#section-3.1) **[Relationship to the "scope" Parameter](https://www.rfc-editor.org/rfc/rfc9396.html#name-relationship-to-the-scope-p)**
...
### [**3.2.**](https://www.rfc-editor.org/rfc/rfc9396.html#section-3.2) **[Relationship to the "resource" Parameter](https://www.rfc-editor.org/rfc/rfc9396.html#name-relationship-to-the-resourc)**

The `resource` authorization request parameter, as defined in \[[RFC8707](https://www.rfc-editor.org/rfc/rfc9396.html#RFC8707)\], can be used to further determine the resources where the requested scope can be applied. The `resource` parameter does not have any impact on the way the AS processes the `authorization_details` authorization request parameter.

## [**4\.**](https://www.rfc-editor.org/rfc/rfc9396.html#section-4) **[Authorization Response](https://www.rfc-editor.org/rfc/rfc9396.html#name-authorization-response)**

This specification does not define extensions to the authorization response.

## [**5\.**](https://www.rfc-editor.org/rfc/rfc9396.html#section-5) **[Authorization Error Response](https://www.rfc-editor.org/rfc/rfc9396.html#name-authorization-error-respons)**
...
## [**6\.**](https://www.rfc-editor.org/rfc/rfc9396.html#section-6) **[Token Request](https://www.rfc-editor.org/rfc/rfc9396.html#name-token-request)**
...
### [**6.1.**](https://www.rfc-editor.org/rfc/rfc9396.html#section-6.1) **[Comparing Authorization Details](https://www.rfc-editor.org/rfc/rfc9396.html#name-comparing-authorization-det)**
...
This shall be illustrated using our running example. The example authorization request in [Section 3](https://www.rfc-editor.org/rfc/rfc9396.html#authz_request), if approved by the user, resulted in the issuance of an authorization code associated with the privileges to:
...
[*Figure 10*](https://www.rfc-editor.org/rfc/rfc9396.html#figure-10)*: [Example of "authorization\_details" Reduced Privileges](https://www.rfc-editor.org/rfc/rfc9396.html#name-example-of-authorization_details-)*  
...
[*Figure 11*](https://www.rfc-editor.org/rfc/rfc9396.html#figure-11)*: [Example of "authorization\_details" Requesting "write" Access to an API](https://www.rfc-editor.org/rfc/rfc9396.html#name-example-of-authorization_details-r)*  
...
[*Figure 12*](https://www.rfc-editor.org/rfc/rfc9396.html#figure-12)*: [Example of "authorization\_details" Requesting "read" Access to an API](https://www.rfc-editor.org/rfc/rfc9396.html#name-example-of-authorization_details-re)*  
...
[*Figure 13*](https://www.rfc-editor.org/rfc/rfc9396.html#figure-13)*: [Example of "authorization\_details" with "admin" Access to an API](https://www.rfc-editor.org/rfc/rfc9396.html#name-example-of-authorization_details-w)*  
...
The next example shows how the client can use the common data element `locations` (see [Section 2.2](https://www.rfc-editor.org/rfc/rfc9396.html#common_data_fields)) to request the issuance of an access token restricted to a certain RS. In our running example, the client may ask for all permissions of the approved grant of type `payment_initiation` applicable to the RS residing at `https://example.com/payments` as follows:
...
[*Figure 14*](https://www.rfc-editor.org/rfc/rfc9396.html#figure-14)*: [Example of "authorization\_details" Requesting an Audience-Restricted Access Token](https://www.rfc-editor.org/rfc/rfc9396.html#name-example-of-authorization_details-re-2)*

## [**7\.**](https://www.rfc-editor.org/rfc/rfc9396.html#section-7) **[Token Response](https://www.rfc-editor.org/rfc/rfc9396.html#name-token-response)**

In addition to the token response parameters as defined in \[[RFC6749](https://www.rfc-editor.org/rfc/rfc9396.html#RFC6749)\], the AS **MUST** also return the `authorization_details` as granted by the resource owner and assigned to the respective access token.
...
[*Figure 15*](https://www.rfc-editor.org/rfc/rfc9396.html#figure-15)*: [Example Token Response](https://www.rfc-editor.org/rfc/rfc9396.html#name-example-token-response)*

### [**7.1.**](https://www.rfc-editor.org/rfc/rfc9396.html#section-7.1) **[Enriched Authorization Details in Token Response](https://www.rfc-editor.org/rfc/rfc9396.html#name-enriched-authorization-deta)**
...
[*Figure 16*](https://www.rfc-editor.org/rfc/rfc9396.html#figure-16)*: [Example of Requested "authorization\_details"](https://www.rfc-editor.org/rfc/rfc9396.html#name-example-of-requested-author)*  
...
[*Figure 17*](https://www.rfc-editor.org/rfc/rfc9396.html#figure-17)*: [Example of Enriched "authorization\_details"](https://www.rfc-editor.org/rfc/rfc9396.html#name-example-of-enriched-authori)*  
...
[*Figure 18*](https://www.rfc-editor.org/rfc/rfc9396.html#figure-18)*: [Example of Requested "authorization\_details"](https://www.rfc-editor.org/rfc/rfc9396.html#name-example-of-requested-authori)*  
...
[*Figure 19*](https://www.rfc-editor.org/rfc/rfc9396.html#figure-19)*: [Example of Enriched "authorization\_details"](https://www.rfc-editor.org/rfc/rfc9396.html#name-example-of-enriched-authoriz)*
...
## [**8\.**](https://www.rfc-editor.org/rfc/rfc9396.html#section-8) **[Token Error Response](https://www.rfc-editor.org/rfc/rfc9396.html#name-token-error-response)**

The Token Error Response **MUST** conform to the rules given in [Section 5](https://www.rfc-editor.org/rfc/rfc9396.html#authz_details_error).

## [**9\.**](https://www.rfc-editor.org/rfc/rfc9396.html#section-9) **[Resource Servers](https://www.rfc-editor.org/rfc/rfc9396.html#name-resource-servers)**
...
### [**9.1.**](https://www.rfc-editor.org/rfc/rfc9396.html#section-9.1) **[JWT-Based Access Tokens](https://www.rfc-editor.org/rfc/rfc9396.html#name-jwt-based-access-tokens)**

If the access token is a JWT \[[RFC7519](https://www.rfc-editor.org/rfc/rfc9396.html#RFC7519)\], the AS is **RECOMMENDED** to add the authorization details object, filtered to the specific audience, as a top-level claim.
...
[*Figure 20*](https://www.rfc-editor.org/rfc/rfc9396.html#figure-20)*: [Example of "authorization\_details" in JWT-Based Access Token](https://www.rfc-editor.org/rfc/rfc9396.html#name-example-of-authorization_details-i)*  
...
### [**9.2.**](https://www.rfc-editor.org/rfc/rfc9396.html#section-9.2) **[Token Introspection](https://www.rfc-editor.org/rfc/rfc9396.html#name-token-introspection)**

Token introspection \[[RFC7662](https://www.rfc-editor.org/rfc/rfc9396.html#RFC7662)\] provides a means for an RS to query the AS to determine information about an access token. If the AS includes authorization detail information for the token in its response, the information **MUST** be conveyed with `authorization_details` as a top-level member of the introspection response JSON object. The `authorization_details` member **MUST** contain the same structure defined in [Section 2](https://www.rfc-editor.org/rfc/rfc9396.html#authz_details), potentially filtered and extended for the RS making the introspection request.
...
[*Figure 21*](https://www.rfc-editor.org/rfc/rfc9396.html#figure-21)*: [Example of "authorization\_details" in Introspection Response](https://www.rfc-editor.org/rfc/rfc9396.html#name-example-of-authorization_details-in)*

## [**10\.**](https://www.rfc-editor.org/rfc/rfc9396.html#section-10) **[Metadata](https://www.rfc-editor.org/rfc/rfc9396.html#name-metadata)**

To advertise its support for this feature, the supported list of authorization details types is included in the AS metadata response \[[RFC8414](https://www.rfc-editor.org/rfc/rfc9396.html#RFC8414)\] using the metadata parameter `authorization_details_types_supported`, which is a JSON array.
...
[*Figure 22*](https://www.rfc-editor.org/rfc/rfc9396.html#figure-22)*: [Example of Server Metadata about the Supported Authorization Details](https://www.rfc-editor.org/rfc/rfc9396.html#name-example-of-server-metadata-)*  
...
[*Figure 23*](https://www.rfc-editor.org/rfc/rfc9396.html#figure-23)*: [Example of Server Metadata about Authorization Details](https://www.rfc-editor.org/rfc/rfc9396.html#name-example-of-server-metadata-a)*  
The registration of authorization details types with the AS is outside the scope of this specification.

## [**11\.**](https://www.rfc-editor.org/rfc/rfc9396.html#section-11) **[Implementation Considerations](https://www.rfc-editor.org/rfc/rfc9396.html#name-implementation-consideratio)**

### [**11.1.**](https://www.rfc-editor.org/rfc/rfc9396.html#section-11.1) **[Using Authorization Details in a Certain Deployment](https://www.rfc-editor.org/rfc/rfc9396.html#name-using-authorization-details)**
...
### [**11.2.**](https://www.rfc-editor.org/rfc/rfc9396.html#section-11.2) **[Minimal Implementation Support](https://www.rfc-editor.org/rfc/rfc9396.html#name-minimal-implementation-supp)**
...
### [**11.3.**](https://www.rfc-editor.org/rfc/rfc9396.html#section-11.3) **[Use of Machine-Readable Type Schemas](https://www.rfc-editor.org/rfc/rfc9396.html#name-use-of-machine-readable-typ)**

Implementations might allow deployments to use machine-readable schema languages for defining authorization details types to facilitate creating and validating authorization details objects against such schemas. For example, if an authorization details `type` were defined using JSON Schemas \[[JSON.Schema](https://www.rfc-editor.org/rfc/rfc9396.html#JSON.Schema)\], the JSON Schema identifier could be used as `type` value in the respective authorization details objects.
...
### [**11.4.**](https://www.rfc-editor.org/rfc/rfc9396.html#section-11.4) **[Large Requests](https://www.rfc-editor.org/rfc/rfc9396.html#name-large-requests)**

Authorization request URIs containing `authorization_details` in a request parameter or a request object can become very long. Therefore, implementers should consider using the `request_uri` parameter as defined in \[[RFC9101](https://www.rfc-editor.org/rfc/rfc9396.html#RFC9101)\] in combination with the pushed request object mechanism as defined in \[[RFC9126](https://www.rfc-editor.org/rfc/rfc9396.html#RFC9126)\] to pass `authorization_details` in a reliable and secure manner. Here is an example of such a pushed authorization request that sends the authorization request data directly to the AS via an HTTPS-protected connection:
...
[*Figure 24*](https://www.rfc-editor.org/rfc/rfc9396.html#figure-24)*: [Example of Large Request including "authorization\_details"](https://www.rfc-editor.org/rfc/rfc9396.html#name-example-of-large-request-in)*

## [**12\.**](https://www.rfc-editor.org/rfc/rfc9396.html#section-12) **[Security Considerations](https://www.rfc-editor.org/rfc/rfc9396.html#name-security-considerations)**

The `authorization_details` parameter is sent through the user agent in case of an OAuth authorization request, which makes them vulnerable to modifications by the user. If the integrity of the `authorization_details` is a concern, clients **MUST** protect `authorization_details` against tampering and swapping. This can be achieved by signing the request using signed request objects as defined in \[[RFC9101](https://www.rfc-editor.org/rfc/rfc9396.html#RFC9101)\] or using the `request_uri` authorization request parameter as defined in \[[RFC9101](https://www.rfc-editor.org/rfc/rfc9396.html#RFC9101)\] in conjunction with \[[RFC9126](https://www.rfc-editor.org/rfc/rfc9396.html#RFC9126)\] to pass the URI of the request object to the AS.

All string comparisons in an `authorization_details` parameter are to be done as defined by \[[RFC8259](https://www.rfc-editor.org/rfc/rfc9396.html#RFC8259)\]. No additional transformation or normalization is to be done in evaluating equivalence of string values.
...
The Security Considerations of \[[RFC6749](https://www.rfc-editor.org/rfc/rfc9396.html#RFC6749)\], \[[RFC7662](https://www.rfc-editor.org/rfc/rfc9396.html#RFC7662)\], and \[[RFC8414](https://www.rfc-editor.org/rfc/rfc9396.html#RFC8414)\] also apply.

## [**13\.**](https://www.rfc-editor.org/rfc/rfc9396.html#section-13) **[Privacy Considerations](https://www.rfc-editor.org/rfc/rfc9396.html#name-privacy-considerations)**

It is especially important for implementers to design and use authorization details in a privacy-preserving manner.

Any sensitive personal data included in `authorization_details` must be prevented from leaking, e.g., through referrer headers. Implementation options include encrypted request objects as defined in \[[RFC9101](https://www.rfc-editor.org/rfc/rfc9396.html#RFC9101)\] or transmission of `authorization_details` via end-to-end encrypted connections between client and AS by utilizing \[[RFC9126](https://www.rfc-editor.org/rfc/rfc9396.html#RFC9126)\] and the `request_uri` authorization request parameter as defined in \[[RFC9101](https://www.rfc-editor.org/rfc/rfc9396.html#RFC9101)\]. The latter does not require application-level encryption, but it requires another message exchange between the client and the AS.
...
## [**14\.**](https://www.rfc-editor.org/rfc/rfc9396.html#section-14) **[IANA Considerations](https://www.rfc-editor.org/rfc/rfc9396.html#name-iana-considerations)**

### [**14.1.**](https://www.rfc-editor.org/rfc/rfc9396.html#section-14.1) **[OAuth Parameters Registration](https://www.rfc-editor.org/rfc/rfc9396.html#name-oauth-parameters-registrati)**

The following parameter has been registered in the "OAuth Parameters" registry \[[IANA.OAuth.Parameters](https://www.rfc-editor.org/rfc/rfc9396.html#IANA.OAuth.Parameters)\] established by \[[RFC6749](https://www.rfc-editor.org/rfc/rfc9396.html#RFC6749)\].
...
### [**14.2.**](https://www.rfc-editor.org/rfc/rfc9396.html#section-14.2) **[JSON Web Token Claims Registration](https://www.rfc-editor.org/rfc/rfc9396.html#name-json-web-token-claims-regis)**

The following value has been registered in the IANA "JSON Web Token Claims" registry established by \[[RFC7519](https://www.rfc-editor.org/rfc/rfc9396.html#RFC7519)\].
...
Reference:  
[Section 9.1](https://www.rfc-editor.org/rfc/rfc9396.html#jwt_based_access_tokens) of RFC 9396

### [**14.3.**](https://www.rfc-editor.org/rfc/rfc9396.html#section-14.3) **[OAuth Token Introspection Response Registration](https://www.rfc-editor.org/rfc/rfc9396.html#name-oauth-token-introspection-r)**

The following value has been registered in the IANA "OAuth Token Introspection Response" registry established by \[[RFC7662](https://www.rfc-editor.org/rfc/rfc9396.html#RFC7662)\].
...
Reference:  
[Section 9.2](https://www.rfc-editor.org/rfc/rfc9396.html#token_introspection) of RFC 9396

### [**14.4.**](https://www.rfc-editor.org/rfc/rfc9396.html#section-14.4) **[OAuth Authorization Server Metadata Registration](https://www.rfc-editor.org/rfc/rfc9396.html#name-oauth-authorization-server-)**

The following values have been registered in the IANA "OAuth Authorization Server Metadata" registry of \[[IANA.OAuth.Parameters](https://www.rfc-editor.org/rfc/rfc9396.html#IANA.OAuth.Parameters)\] established by \[[RFC8414](https://www.rfc-editor.org/rfc/rfc9396.html#RFC8414)\].
...
Reference:  
[Section 10](https://www.rfc-editor.org/rfc/rfc9396.html#metadata) of RFC 9396

### [**14.5.**](https://www.rfc-editor.org/rfc/rfc9396.html#section-14.5) **[OAuth Dynamic Client Registration Metadata Registration](https://www.rfc-editor.org/rfc/rfc9396.html#name-oauth-dynamic-client-regist)**

The following value has been registered in the IANA "OAuth Dynamic Client Registration Metadata" registry of \[[IANA.OAuth.Parameters](https://www.rfc-editor.org/rfc/rfc9396.html#IANA.OAuth.Parameters)\] established by \[[RFC7591](https://www.rfc-editor.org/rfc/rfc9396.html#RFC7591)\].
...
### [**14.6.**](https://www.rfc-editor.org/rfc/rfc9396.html#section-14.6) **[OAuth Extensions Error Registration](https://www.rfc-editor.org/rfc/rfc9396.html#name-oauth-extensions-error-regi)**

The following value has been registered in the IANA "OAuth Extensions Error Registry" of \[[IANA.OAuth.Parameters](https://www.rfc-editor.org/rfc/rfc9396.html#IANA.OAuth.Parameters)\] established by \[[RFC6749](https://www.rfc-editor.org/rfc/rfc9396.html#RFC6749)\].
...
Reference:  
[Section 5](https://www.rfc-editor.org/rfc/rfc9396.html#authz_details_error) of RFC 9396

## [**15\.**](https://www.rfc-editor.org/rfc/rfc9396.html#section-15) **[References](https://www.rfc-editor.org/rfc/rfc9396.html#name-references)**

### [**15.1.**](https://www.rfc-editor.org/rfc/rfc9396.html#section-15.1) **[Normative References](https://www.rfc-editor.org/rfc/rfc9396.html#name-normative-references)**
...
### [**15.2.**](https://www.rfc-editor.org/rfc/rfc9396.html#section-15.2) **[Informative References](https://www.rfc-editor.org/rfc/rfc9396.html#name-informative-references)**

**\[CSC\]**

Cloud Signature Consortium, "Architectures and protocols for remote signature applications", Version 1.0.4.0, June 2019, \<[https://cloudsignatureconsortium.org/wp-content/uploads/2020/01/CSC\_API\_V1\_1.0.4.0.pdf](https://cloudsignatureconsortium.org/wp-content/uploads/2020/01/CSC_API_V1_1.0.4.0.pdf)\>.

**\[ETSI\]**

ETSI, "Electronic Signatures and Infrastructures (ESI); Protocols for remote digital signature creation", V1.1.1, ETSI TS 119 432, March 2019, \<[https://www.etsi.org/deliver/etsi\_ts/119400\_119499/119432/01.01.01\_60/ts\_119432v010101p.pdf](https://www.etsi.org/deliver/etsi_ts/119400_119499/119432/01.01.01_60/ts_119432v010101p.pdf)\>.
...
OpenJS Foundation, "JSON Schema", \<[https://json-schema.org/](https://json-schema.org/)\>.
...
Sakimura, N., Bradley, J., Jones, M., de Medeiros, B., and C. Mortimore, "OpenID Connect Core 1.0 incorporating errata set 1", 8 November 2014, \<[https://openid.net/specs/openid-connect-core-1\_0.html](https://openid.net/specs/openid-connect-core-1_0.html)\>.
...
Lodderstedt, T., "Transaction Authorization or why we need to re-think OAuth scopes", 20 April 2019, \<[https://medium.com/oauth-2/transaction-authorization-or-why-we-need-to-re-think-oauth-scopes-2326e2038948](https://medium.com/oauth-2/transaction-authorization-or-why-we-need-to-re-think-oauth-scopes-2326e2038948)\>.

## [**Appendix A.**](https://www.rfc-editor.org/rfc/rfc9396.html#appendix-A) **[Additional Examples](https://www.rfc-editor.org/rfc/rfc9396.html#name-additional-examples)**

### [**A.1.**](https://www.rfc-editor.org/rfc/rfc9396.html#appendix-A.1) **[OpenID Connect](https://www.rfc-editor.org/rfc/rfc9396.html#name-openid-connect)**

OpenID Connect \[[OIDC](https://www.rfc-editor.org/rfc/rfc9396.html#OIDC)\] specifies the JSON-based `claims` request parameter that can be used to specify the claims a client (acting as an OpenID Connect Relying Party) wishes to receive in a fine-grained and privacy-preserving way as well as assign those claims to certain delivery mechanisms, i.e., ID Token or userinfo response.
...
The top-level fields are based on the definitions given in \[[OIDC](https://www.rfc-editor.org/rfc/rfc9396.html#OIDC)\]:
...
`claims`:  
the `claims` JSON structure as defined in \[[OIDC](https://www.rfc-editor.org/rfc/rfc9396.html#OIDC)\]
...
[*Figure 25*](https://www.rfc-editor.org/rfc/rfc9396.html#figure-25)*: [Example of OpenID Connect Request Utilizing "authorization\_details"](https://www.rfc-editor.org/rfc/rfc9396.html#name-example-of-openid-connect-r)*
...
A more sophisticated example is shown in [Figure 26](https://www.rfc-editor.org/rfc/rfc9396.html#fig26).
...
[*Figure 26*](https://www.rfc-editor.org/rfc/rfc9396.html#figure-26)*: [Advanced Example of OpenID Connect Request Utilizing "authorization\_details"](https://www.rfc-editor.org/rfc/rfc9396.html#name-advanced-example-of-openid-)*

### [**A.2.**](https://www.rfc-editor.org/rfc/rfc9396.html#appendix-A.2) **[Remote Electronic Signing](https://www.rfc-editor.org/rfc/rfc9396.html#name-remote-electronic-signing)**

The following example is based on the concept laid out for remote electronic signing in ETSI TS 119 432 \[[ETSI](https://www.rfc-editor.org/rfc/rfc9396.html#ETSI)\] and the Cloud Signature Consortium (CSC) API for remote signature creation \[[CSC](https://www.rfc-editor.org/rfc/rfc9396.html#CSC)\].
...
[*Figure 27*](https://www.rfc-editor.org/rfc/rfc9396.html#figure-27)*: [Example of Electronic Signing](https://www.rfc-editor.org/rfc/rfc9396.html#name-example-of-electronic-signi)*  
...
### [**A.3.**](https://www.rfc-editor.org/rfc/rfc9396.html#appendix-A.3) **[Access to Tax Data](https://www.rfc-editor.org/rfc/rfc9396.html#name-access-to-tax-data)**
...
[*Figure 28*](https://www.rfc-editor.org/rfc/rfc9396.html#figure-28)*: [Example of Tax Data Access](https://www.rfc-editor.org/rfc/rfc9396.html#name-example-of-tax-data-access)*  
The top-level fields have the following meaning:
...
### [**A.4.**](https://www.rfc-editor.org/rfc/rfc9396.html#appendix-A.4) **[eHealth](https://www.rfc-editor.org/rfc/rfc9396.html#name-ehealth)**
...
[*Figure 29*](https://www.rfc-editor.org/rfc/rfc9396.html#figure-29)*: [eHealth Example](https://www.rfc-editor.org/rfc/rfc9396.html#name-ehealth-example)*  
...
[*Figure 30*](https://www.rfc-editor.org/rfc/rfc9396.html#figure-30)*: [Advanced eHealth Example](https://www.rfc-editor.org/rfc/rfc9396.html#name-advanced-ehealth-example)*  
...
## [**Acknowledgements**](https://www.rfc-editor.org/rfc/rfc9396.html#name-acknowledgements)
...
## [**Authors' Addresses**](https://www.rfc-editor.org/rfc/rfc9396.html#name-authors-addresses)
