...
ALTER TABLE hydra_oauth2_flow ADD COLUMN authorization_details jsonb NULL;
ALTER TABLE hydra_oauth2_flow ADD COLUMN issuer_state VARCHAR(4096) NULL DEFAULT '';
ALTER TABLE hydra_oauth2_flow ADD COLUMN consent_authorization_details jsonb NULL;
